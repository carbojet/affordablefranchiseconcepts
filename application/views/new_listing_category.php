        ...
        <div class="span12">
          ...
          <div class="portlet box grey" style="border-color:#008080;">
            ...
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form name="form" id="form" action="<?php echo base_url("listing/add_listing_category/");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                ...
                <div class="control-group form_field">
                  <label class="control-label">Choose Sector <span class="required">*</span></label>
                  <div class="controls">
                    <div id="listing_sector_1" style="current:block; padding-top:0px">
                      <select name="listing_sector" id="listing_sector" class="span6 m-wrap" onChange="jQuery.fn.ajax_category_list(this.value,0);">
                        <option value="" selected="selected"></option>
                        <?php

														$sector_detail = $this->Listingdb->sector_list();

														//var_dump($category_detail);

														foreach($sector_detail as $k=>$sector_detailObj)

														{?>
                        <option value="<?php echo $sector_detailObj->category_id ?>"><?php echo $sector_detailObj->category_name_1; ?></option>
                        <?php	}?>
                      </select>
                    </div>
...
<script>
...

		{
			...
			jQuery.ajax({
				...
				url:'http://www.affordablebusinessconcepts.com/directory/listing/ajax_category_list'+'/'+id,
				...
				success:function(data){
...

					{
						...
						$("#listing_category_1").find("select option").remove();

						for(var key in data){

						$("#listing_category_1").find("select").append('<option value="'+key+'">'+data[key]+'</option>')
