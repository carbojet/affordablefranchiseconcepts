					...
					<div class="span12">
						...
						<div class="portlet box grey" style="border-color:#004080;">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->		
									<form name="form" id="form" action="<?php echo base_url("listing/add_own_listing_video/");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="external" checked="checked" onClick="location.href='<?php echo base_url("listing/add_own_listing_video/".$listingObj->listing_id."/external/");?>'" style="opacity: 0;"></span></div>
												I want to link to external video url.
											</label>
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="youtube" onClick="location.href='<?php echo base_url("listing/add_own_listing_video/".$listingObj->listing_id."/youtube/");?>'" style="opacity: 0;"></span></div>
									...
									<div class="space20"></div>
									<div class="control-group form_field" style="margin-bottom:0">
										<label class="control-label">Enter Video URL <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="video_url" value="http://www." data-required="1" class="span8 m-wrap" style="">
										</div>
									</div>
									<div class="space20"></div>	
									<div class="space20"></div>																				
