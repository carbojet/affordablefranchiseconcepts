        ...
        <div class="span12">
          <div style="border-color:#461B7E;" class="portlet box grey">
            <div style="background-color:#461B7E;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Location</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url()."general/setup_location_update"; ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $locationObj->location_id; ?>" name="location_id">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="<?php echo $locationObj->location_name; ?>" name="location_name">
                    <input type="hidden" value="text" name="required_location_name">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">SEO Friendly Name <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="<?php echo $locationObj->location_url; ?>" name="location_url">
                    <input type="hidden" value="text" name="required_location_url">
                  </div>
                </div>
				...
				init: function () {
					...
					this_form.validate({
						...
						rules: {
							...
							location_url:								{ required: true },
						},
						
						// custom messages for radio buttons and checkboxes
						messages: {
							location_name: 								{ required: "Please fill this field." },
							location_url: 								{ required: "Please fill this field." },
						},
