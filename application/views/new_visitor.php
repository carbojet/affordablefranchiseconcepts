				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("visitor/add_visitor");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<input type="text" name="visitor_username" value="<?php echo $visitorObj->visitor_username;?>" data-required="1" class="span4 m-wrap" style="">										</div>
									</div>
									<div class="control-group form_field">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<?php 	foreach($countryObjArray as $k=>$countryObj) { ?>
													<?php if($k==$visitorObj->visitor_country) {?>
										...
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												...
												<div>
													...
													<input name="visitor_logo" type="file" class="default"></span>
