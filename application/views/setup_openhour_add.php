  ...
  <div class="page-content" data-height="1583" style="">
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid inbox">
        <div class="span12">
          <div style="border-color:#151B54;" class="portlet box grey">
            <div style="background-color:#151B54;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i>Add Open Hour Values</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" id="form" action="<?php echo base_url("general/setup_openhour_add"); ?>">
                ...
                <div style="margin-top:0;" class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_1_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_2_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_3_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_4_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_5_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_6_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_7_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_8_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_9_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="openhour_name_10_1">
                  </div>
                </div>
                <div class="form-actions">
                  <button style="background-color:#151B54;" class="btn black" type="submit"><i class="icon-ok"></i> Save</button>
                </div>
              </form>
              <!-- END FORM-->
            </div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						ignore: "",
						rules: {
														radius_name_1: 		{ required: true },
														radius_value: 							{ required: true, digits: true },
						},
						
						// custom messages for radio buttons and checkboxes
						messages: {
														radius_name_1: 		{ required: "Please fill this field." },
														radius_value: 							{ required: "Please fill this field.", digits: "Please enter only digits." },
						},
