					...
					<div class="span12">
						...
						<div class="portlet box grey" style="border-color:#461B7E;">
							<div class="portlet-title" style="background-color:#461B7E;">
								<div class="caption"><i class="icon-edit"></i> Edit Seller</div>
							</div>
							
							
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("seller/update");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                ...
                                <input type="hidden" name="page" value="<?php echo $page;?>">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<input type="text" name="seller_username" value="<?php echo $sellerObj->seller_username; ?>" data-required="1" class="span4 m-wrap" style="" disabled="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Password <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="seller_password" value="<?php echo $sellerObj->seller_password; ?>" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="space20"></div>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
                                            ...
                                            <?php
												...
												{?>
                                                	<?php if($k==$sellerObj->seller_package){ ?>
									...
									<div class="control-group form_field" style="margin-bottom:0">
										...
										<div class="controls">
                                            ...
                                            <?php
												$temp_array = array("monthly"=>"Monthly","quarterly"=>"3 Months","semiannually"=>"6 Months","annually"=>"12 Months");
												foreach($temp_array as $k=>$val)
												{?>
                                                	<?php if($k==$sellerObj->seller_payment_period){ ?>
													<option value="<?php echo $k ?>" selected="selected"><?php echo $val ?></option>
                                                    <?php }else{ ?>
									...
									<div class="control-group form_field" style="margin-bottom:0">
										...
										<div class="controls">
											<input type="text" name="seller_expire_date" value="<?php echo date("Y-m-d",strtotime($sellerObj->seller_expire_date)); ?>" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group" style="margin-top:0;">
										<label class="control-label"></label>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<?php 	foreach($countryObjArray as $k=>$countryObj) { ?>
														<?php if($countryObj->country_id==$sellerObj->seller_country) { ?>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<label class="radio">
												<div class="radio" id="uniform-undefined"><span class=""><input name="seller_type" type="radio" value="personal" style="opacity: 0;" <?php if($sellerObj->seller_type=="personal"){ echo 'checked="checked"';}?>"></span></div>
												Personal
											</label>
											<br>
											<label class="radio">
												<div class="radio" id="uniform-undefined"><span class="checked"><input name="seller_type" type="radio" value="company" <?php if($sellerObj->seller_type=="company"){ echo "checked='checked'";}?> style="opacity: 0;"></span></div>
												Company
											</label>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="seller_desc_1" class="span8 m-wrap" rows="6">We are a reliable and experienced contracting company that specializes in home repairs and renovations. We have 16 employees. We are a registered contractor in New Jersey and we carry all necessary insurance. We do not charge for estimates. Award winning. Subcontracting used for plumbing and electrical services</textarea>
										</div>
									</div>
									<div class="space20"></div>
