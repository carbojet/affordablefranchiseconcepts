					...
					<div class="span12">
						...
						<div class="portlet box grey" style="border-color:#004080;">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->		
									<form name="form" id="form" action="<?php echo base_url("listing/add_listing_video/".$listingObj->listing_id);?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span class="checked"><input type="radio" name="video_type" value="upload" onClick="location.href='<?php echo base_url("listing/add_listing_video/".$listingObj->listing_id."/upload/");?>'" style="opacity: 0;"></span></div>
												I want to upload video from my harddrive.
											</label>
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="external" onClick="location.href='<?php echo base_url("listing/add_listing_video/".$listingObj->listing_id."/external/");?>'" style="opacity: 0;"></span></div>
												I want to link to external video url.
											</label>
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="youtube" checked="checked" onClick="location.href='<?php echo base_url("listing/add_listing_video/".$listingObj->listing_id."/youtube/");?>'" style="opacity: 0;"></span></div>
