  ...
  <div class="page-content" data-height="860" style="">
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid inbox">
        <div class="span12">
          <div style="border-color:#004080;" class="portlet box grey">
            <div style="background-color:#004080;" class="portlet-title">
              <div class="caption"> <i class="icon-edit"></i> Add Locations </div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url('general/setup_location_add'); ?>" id="form" name="form">
                <input type="hidden" value="<?php if(isset($parent_location)){ echo $parent_location; } ?>" name="location_parent">
                ...
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 1<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name1">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 2<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name2">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 3<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name3">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 4<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name4">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 5<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name5">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 6<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name6">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 7<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name7">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 8<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name8">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 9<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name9">
                  </div>
                </div>
                <div style="margin-top:0;" class="control-group">
                  <label class="control-label">Location 10<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="location_name10">
                  </div>
                </div>
                <div class="form-actions">
                  <button style="background-color:#004080;" class="btn black" type="submit"><i class="icon-ok"></i> Save</button>
                </div>
              </form>
              <!-- END FORM-->
            </div>
				...
				init: function () {
					...
					this_form.validate({
						...
						rules: {
							...
							discount_expire: 						{ required: true },
						},
						
						// custom messages for radio buttons and checkboxes
						messages: {
							discount_code: 							{ required: "Please fill this field." },
							discount_percentage: 					{ required: "Please fill this field.", number: "Please enter only digits." },
							discount_expire: 						{ required: "Please fill this field." },
						},
