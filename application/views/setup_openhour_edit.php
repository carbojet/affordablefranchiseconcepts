        ...
        <div class="span12">
          <div style="border-color:#004080;" class="portlet box grey">
            <div style="background-color:#004080;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Open Hour Value</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_openhour_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $openhourObj->openhour_id; ?>" name="openhour_id">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="<?php echo $openhourObj->openhour_name_1; ?>" name="openhour_name_1">
                  </div>
                </div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						ignore: "",
						rules: {
														openstatus_name_1: 		{ required: true, minlength: 3 },
													},
						
						// custom messages for radio buttons and checkboxes
						messages: {
														openstatus_name_1: 		{ required: "Please fill this field.", minlength: "Please enter at least 3 characters." },
													},
