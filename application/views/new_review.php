...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
		...
		?>		
		<!-- BEGIN PAGE -->
		<div class="page-content" data-height="939">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
										...
										<div style="padding:0 0 10px 0;">
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<li><a href="listing_category.php?listing=116"><i class="icon-sitemap"></i> Categories </a></li>
													
																										<li><a href="listing_photo.php?listing=116"><i class="icon-picture"></i> Photos <font dir="ltr">(8)</font> </a></li>
																										
																										<li><a href="listing_video.php?listing=116"><i class="icon-facetime-video"></i> Videos <font dir="ltr">(0)</font> </a></li>
																										
																										<li><a href="listing_document.php?listing=116"><i class="icon-briefcase"></i> Documents <font dir="ltr">(0)</font> </a></li>
																										
																										<li><a href="listing_event.php?listing=116"><i class="icon-calendar"></i> Events <font dir="ltr">(0)</font> </a></li>
																										
																										<li><a href="listing_coupon.php?listing=116"><i class="icon-barcode"></i> Coupons <font dir="ltr">(0)</font> </a></li>
																										
																										<li><a href="listing_product.php?listing=116"><i class="icon-gift"></i> Products <font dir="ltr">(0)</font> </a></li>
																										
																										<li><a href="listing_news.php?listing=116"><i class="icon-book"></i> News <font dir="ltr">(0)</font> </a></li>
						...
						<div class="portlet box grey" style="border-color:#400000;">
							<div class="portlet-title" style="background-color:#400000;">
								<div class="caption"><i class="icon-comments"></i>Add Review / Comment</div>
							</div>
							...
							<div class="portlet-body form">
							  ...
							  <?php } ?>
								...
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("listing/new_review/"); ?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
								<input name="comment_linkid" type="hidden" value="<?php echo $reviewObj->comment_linkid;?>">
                                <input type="hidden" name="comment_visitor" value="<?php echo $reviewObj->comment_visitor;?>">
                                <?php
								...
								?>
                                <input type="hidden" name="comment_ipaddress" value="<?php echo $ip; ?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<span class="text bold" style="color:#900"><?php echo $visitorObj->visitor_username;?></span>
									</div>
								</div>
								...
								<div class="control-group form_field">
									...
									<div class="controls">
										 	<label class="radio">
											<div class="radio" id="uniform-undefined"><span class="checked"><input name="comment_rating" type="radio" value="5" checked="" style="opacity: 0;"></span></div>
											<img width="84" height="16" src="<?php echo base_url("theme");?>/img/stars/pic_star5.png" alt="" style="width:84px; height:16px;">
										</label>
										<br>
																				<label class="radio">
											<div class="radio" id="uniform-undefined"><span><input name="comment_rating" type="radio" value="4" style="opacity: 0;"></span></div>
											<img width="84" height="16" src="<?php echo base_url("theme");?>/img/stars/pic_star4.png" alt="" style="width:84px; height:16px;">
										</label>
										<br>
																				<label class="radio">
											<div class="radio" id="uniform-undefined"><span><input name="comment_rating" type="radio" value="3" style="opacity: 0;"></span></div>
											<img width="84" height="16" src="<?php echo base_url("theme");?>/img/stars/pic_star3.png" alt="" style="width:84px; height:16px;">
										</label>
										<br>
																				<label class="radio">
											<div class="radio" id="uniform-undefined"><span><input name="comment_rating" type="radio" value="2" style="opacity: 0;"></span></div>
											<img width="84" height="16" src="<?php echo base_url("theme");?>/img/stars/pic_star2.png" alt="" style="width:84px; height:16px;">
										</label>
										<br>
																				<label class="radio">
											<div class="radio" id="uniform-undefined"><span><input name="comment_rating" type="radio" value="1" style="opacity: 0;"></span></div>
											<img width="84" height="16" src="<?php echo base_url("theme");?>/img/stars/pic_star1.png" alt="" style="width:84px; height:16px;">
										</label>
										<br>
									</div>
								</div>
								...
								<div class="form-actions">
									<button type="submit" class="btn black" style="background-color:#400000;"><i class="icon-ok"></i> Save</button>
								</div>
								</form>
								<!-- END FORM-->
				...
				init: function () {
					...
					this_form.validate({
						...
						rules: {
							...
							comment_language:					{ required: true },
						...
						messages: {
							...
							comment_title:						{ required: "Please fill this field." },
							comment_description:				{ required: "Please fill this field." },
							comment_language:					{ required: "Please fill this field." },
							// comment_rating:					{ required: "Please fill this field." },
