...
<div class="page-container row-fluid">
  ...
  <?php
			...
			$sidemenu[2] =array("1"=>"active","3"=>array("1"=>"active","2"=>array("4"=>"active")));
            ...
            <div class="span12">
              ...
              <div class="portlet">
                <div class="portlet-title">
                  <div class="caption"> <i class="icon-cogs"></i> Manage Listing Industry Values </div>
                  <div class="actions">
                    <div class="btn-group">
                      <button data-toggle="dropdown" class="btn red dropdown-toggle">Options <i class="icon-angle-down"></i></button>
                      <ul class="dropdown-menu pull-right">
                        <!--<li><a href="<?php echo base_url("general/setup_sector_listing_add/$sector_parent/"); ?>"><i class="icon-plus"></i> Add New</a></li>-->
                        <li><a href="#" onClick="confirm_delete_all();"><i class="icon-trash"></i> Delete All</a></li>
                        <?php /*?><li><a style="cursor:pointer" href="<?php echo base_url("general/setup_category_reset"); ?>"><i class="icon-refresh"></i> Reset</a></li><?php */?>
                      </ul>
                    </div>
                  </div>
                </div>
				...
				if(isset($success_msg))
                  ...
                  <ul style="margin-bottom:5px;" class="breadcrumb">
                    <li> <i class="icon-globe"></i> <a href="<?php echo base_url("general/setup_sector_listing/") ?>">Industry</a> </li>
                  </ul>
                  <table id="sample_1" class="table table-bordered table-advance table-hover">
                    ...
                    <tbody>
                      <?php if(count($sector_listing_list)>0){ foreach($sector_listing_list as $k=>$category_listingObj){ ?>
                      <tr>
                        <td style="padding-right:20px"><a href="#">
                          <h5 style="font-weight:700; margin:0"><?php echo $category_listingObj->category_name_1; ?></h5>
                          </a> Industry # <?php echo $category_listingObj->category_id; ?> <br>
                          <div class="btn-group"> <a href="#" data-toggle="dropdown" class="btn mini yellow dropdown-toggle">Edit <i class="icon-angle-down"></i></a>
                            <ul class="dropdown-menu">
                              <li><a href="<?php echo base_url("general/setup_sector_listing_edit/".$category_listingObj->category_id); ?>"><i class="icon-edit"></i> Edit</a></li>
                              <!--<li><a style="cursor:pointer" onClick="confirm_delete('<?php echo $category_listingObj->category_id; ?>','<?php echo $category_listingObj->category_name_1; ?>')"><i class="icon-trash"></i> Delete</a></li>-->                             
                            </ul>
                          </div></td>
                        <td style="text-align:center; vertical-align:middle" class="hidden-480"><?php echo $this->Generaldb->setup_listings_sector_count($category_listingObj->category_id); ?></td>
          ...
          <div style="padding-bottom:50px">
            ...
            <div style="float:right">
              <div class="hidden-480" style="float:right">
                <div dir="ltr"> <a href="<?php echo base_url("general/sector_listing_pre_page/0/".$pagination["startpage"]); ?>" class="btn black"><i class="m-icon-swapleft m-icon-white"></i> Prev</a> <a href="<?php echo base_url("general/sector_listing_nxt_page/0/".$pagination["startpage"]); ?>" class="btn black">Next <i class="m-icon-swapright m-icon-white"></i></a> </div>
              </div>
            </div>
			...
			jQuery("body").on("keyup","input[name=navigation_page]",function(e){
				...
				{				
					...
					if(currntpage <= pagenum){					
						window.location = "<?php echo base_url("general/sector_listing_nxt_page/0"); ?>"+"/"+pagenum;
					}else{
						window.location = "<?php echo base_url("general/sector_listing_pre_page/0"); ?>"+"/"+pagenum;
					}				
				}
			})
...
<script type="text/javascript">
		...
		function confirm_delete(id, name){	
			...
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				...
				window.location = "<?php echo base_url()."general/delete_setup_sector_listing/"; ?>" + id; 
