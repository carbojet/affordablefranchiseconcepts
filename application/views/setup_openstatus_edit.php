  ...
  <div class="page-content" data-height="860" style="">
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid inbox">
        <div class="span12">
          <div style="border-color:#493D26;" class="portlet box grey">
            <div style="background-color:#493D26;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Open Status Value</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_openstatus_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $openstatusObj->openstatus_id; ?>" name="openstatus_id">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="<?php echo $openstatusObj->openstatus_name_1; ?>" name="openstatus_name_1">
                  </div>
                </div>
                <div class="form-actions">
                  <button style="background-color:#493D26;" class="btn black" type="submit"><i class="icon-ok"></i> Save</button>
                </div>
              </form>
              <!-- END FORM-->
            </div>
