					...
					<div class="span12">
						<div class="portlet box grey" style="border-color:#800000;">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url('listing/update_seller_listing/');?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
								<input name="listing_id" type="hidden" value="<?php echo $listingObj->listing_id; ?>">
                                <input name="listing_seller" type="hidden" value="<?php echo $listingObj->listing_seller; ?>">
									...
									<div class="space20"></div>
										...
										<div class="controls">
											<div id="listing_category_1" style="current:block; padding-top:0px">
												<select name="listing_category" id="box_listing_category_1" class="span6 m-wrap" onChange="">                 							<?php
