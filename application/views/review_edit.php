						...
						<div class="portlet box grey" style="border-color:#400000;">
							...
							<div class="portlet-body form">
							  ...
							  <?php } ?>
								...
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("listing/update_review/"); ?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
								<input name="comment_id" type="hidden" value="<?php echo $reviewObj->comment_id;?>">
                                <input type="hidden" name="comment_linkid" value="<?php echo $reviewObj->comment_linkid;?>">
                                <?php
								...
								<div class="control-group">
									...
									<div class="controls">
										<span class="text bold" style="color:#900"><?php echo $reviewObj->visitor_username;?></span>
									</div>
								</div>
