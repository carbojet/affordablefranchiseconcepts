...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
        ...
        <!-- approval -->
		<?php
			$sidemenu[6] =array("1"=>"active","2"=>array("4"=>"active"));
							...
							<div class="span12">
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption"><i class="icon-money"></i>Cancelled Payments</div>
										...
										<tbody>
											...
											<td style="vertical-align:middle;">
												...
												<div style="margin:5px 0 5px 0">
																								...
																								<a class="btn mini green" onClick="confirm_approve(<?php echo $paymentObj->payment_id;?>, <?php echo $paymentObj->payment_id;?>)" style="cursor:pointer"><i class="icon-thumbs-up"></i> Approve</a>
											...
											<td class="hidden-320" style="vertical-align:middle; text-align:center">
												 <div class="btn mini red"><?php echo $paymentObj->payment_status;?></div> 																																				</td>
						...
						<div style="padding-bottom:50px">
							<div class="control-group" style="float:left">
								<div class="controls" style="font-weight:bold">
									...
									<form name="pagination" action="<?php echo base_url("payment/cancelled_payments/");?>" method="post">
