					...
					<div class="span12">
						...
						<div class="portlet box grey" style="border-color:#004080;">
							<div class="portlet-title" style="background-color:#004080;">
								<div class="caption"><i class="icon-facetime-video"></i>Add Video</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->		
									<form name="form" id="form" action="<?php echo base_url("listing/add_own_listing_video/".$listingObj->listing_id);?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span class="checked"><input type="radio" name="video_type" value="upload" onClick="location.href='<?php echo base_url("listing/add_own_listing_video/".$listingObj->listing_id."/upload/");?>'" style="opacity: 0;"></span></div>
												I want to upload video from my harddrive.
											</label>
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="external" onClick="location.href='<?php echo base_url("listing/add_own_listing_video/".$listingObj->listing_id."/external/");?>'" style="opacity: 0;"></span></div>
												I want to link to external video url.
											</label>
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="youtube" checked="checked" onClick="location.href='<?php echo base_url("listing/add_own_listing_video/".$listingObj->listing_id."/youtube/");?>'" style="opacity: 0;"></span></div>
									...
									<div class="control-group ">
										...
										<div class="controls">
											<input type="text" name="video_title_1" value="" data-required="1" class="span6 m-wrap" style="">
										</div>
									</div>
										...
										<div class="controls">
											<div class="fileupload fileupload-new" data-provides="fileupload">
												...
												<div>
													...
													<input name="video_photo" type="file" class="default" ></span>
									...
									<div class="space20"></div>
									<div class="control-group form_field">
										<label class="control-label">Enter YouTube HTML Codes <span class="required">*</span></label>
										<div class="controls">
			                                <textarea name="video_youtube" class="span8 m-wrap" rows="5"></textarea>
											<input type="hidden" name="required_video_youtube" value="text">
										</div>
									</div>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
			                                <textarea name="video_description_1" class="span8 m-wrap" rows="5"></textarea>
										</div>
									</div>
