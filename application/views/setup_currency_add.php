  ...
  <div class="page-content" data-height="860" style="">
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid inbox">
        <div class="span12">
          <div style="border-color:#800000;" class="portlet box grey">
            <div style="background-color:#800000;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Add Currency Code</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_currency_add") ?>" id="form" name="form" novalidate="novalidate">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="" name="currency_name">
                    <input type="hidden" value="text" name="required_currency_name">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">Currency Symbol <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="" name="currency_symbol">
                    <input type="hidden" value="text" name="required_currency_symbol">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">Currency Code <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="" name="currency_code">
                    <input type="hidden" value="text" name="required_currency_code">
                  </div>
                </div>
                <div class="form-actions">
                  <button style="background-color:#800000;" class="btn black" type="submit"><i class="icon-ok"></i> Save</button>
                </div>
              </form>
              <!-- END FORM-->
            </div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						messages: {
							currency_name: 							{ required: "Please fill this field." },
							currency_symbol: 						{ required: "Please fill this field." },
							currency_code: 							{ required: "Please fill this field." },
						},
