				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
							...
							<div class="portlet-title" style="background-color:#9F000F;">
								<div class="caption"><i class="icon-edit"></i> Listing Fields Editor : Edit Field Name</div>
							</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("listing/setup_field_listing_edit/");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
								<input name="field_listing_id" type="hidden" value="<?php echo $field_listingObj->field_listing_id;?>">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<input type="text" name="field_listing_name_1" value="<?php echo $field_listingObj->field_listing_name_1;?>" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						rules: {
														field_listing_name_1: 		{ required: true },
													},
						
						// custom messages for radio buttons and checkboxes
						messages: {
														field_listing_name_1: 		{ required: "Please fill this field." },
													},
