...
<div class="page-container row-fluid">
  ...
  ?>
  <!-- BEGIN PAGE -->
  <div class="page-content" data-height="1235" style="">
        ...
        <div class="span12">
          <div style="border-color:#400000;" class="portlet box grey">
            <div style="background-color:#400000;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Listing Category</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_category_listing_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $category_listingObj->category_id; ?>" name="category_id">
                ...
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                  ...
                  <div class="controls">
                    <h5 style="font-weight:700">Enter Category Name / Title (Required)</h5>
                    <div style="margin-left:0; padding-left:0" class="span6"> You can specify your enter Category Name / Title for each languages. </div>
                  </div>
                </div>
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" class="span8 m-wrap" data-required="1" value="<?php echo $category_listingObj->category_name_1; ?>" name="category_name_1">
                  </div>
                </div>
                                <div class="space20"></div>
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                  <label class="control-label"></label>
                  <div class="controls">
                    <h5 style="font-weight:700">Choose Sector Name (Required)</h5>                    
                  </div>
                </div>
                <div class="space20"></div>
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required">*</span></label>
                  <div class="controls">
                  	<select name="sector_name" data-required="1" class="span8 m-wrap">
						...
						?>
                    	<option value="<?php echo $sectorlistObj->category_id; ?>"  <?php if($sectorlistObj->category_id == $category_listingObj->category_parent){?>selected <?php } ?>><?php echo $sectorlistObj->category_name_1; ?></option>
                        <?php }} ?>
                    </select>                    
                  </div>
                </div>
                ...
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                  <label class="control-label"></label>
                  <div class="controls">
                    <h5 style="font-weight:700">Enter Friendly URL (Optional)</h5>
                    <div style="margin-left:0; padding-left:0" class="span6"> You can specify your own Friendly URL for each languages. If you don't specify the friendly url, the system will automatically create it for you. </div>
                  </div>
                </div>
                <div class="space10"></div>
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="<?php echo $category_listingObj->category_url_1; ?>" name="category_url_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                  <label class="control-label"></label>
                  <div class="controls">
                    <h5 style="font-weight:700">Enter Short Description (Optional)</h5>
                    <div style="margin-left:0; padding-left:0" class="span6"> You can specify your own short description for each languages. </div>
                  </div>
                </div>
                <div class="space10"></div>
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span8 m-wrap" data-required="1" value="<?php $dest = $category_listingObj->category_desc_1; echo trim($dest); ?>" name="category_desc_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
               <!-- <div style="margin-bottom:0" class="control-group form_field">
                  ...
                  <div class="controls">
                    <div data-provides="fileupload" class="fileupload fileupload-new">
                      <div class="input-append">
                        ...
                        <input type="file" class="default" name="category_icon">
                        </span> <a data-dismiss="fileupload" class="btn fileupload-exists" href="#">Remove</a> </div>
                    </div>
                  </div>
                </div>
                <div style="margin-top:0; padding-top:0" class="control-group">
                  <label class="control-label"></label>
                  <div class="controls"> <span class="label label-important">Note :</span> <span>Please only upload JPG or JPEG file only ...</span> <br>
                    You can upload an image, picture or icon for this category.
                    <div>
                      <?php

               $url = base_url()."category_listing_cache/".$category_listingObj->category_id.".jpg";

               $url = get_headers($url, 1);

               if($url[0]!="HTTP/1.0 404 Not Found")

               {

              ?>
                      <img border="0" style="margin-top:40px; margin-bottom:5px" src="<?php echo base_url("category_listing_cache/".$category_listingObj->category_id);?>.jpg">
                      <?php } ?>
                      <br>
                      <a class="btn mini red" style="cursor:pointer" onClick="confirm_delete('<?php echo $category_listingObj->category_id; ?>');">Delete</a> </div>
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>-->
...
<script type="text/javascript">
	...
	<!--
		...
		function confirm_delete(id){
			...
			if ( confirm("Do you want to delete this picture / icon?") ){

				window.location = "<?php echo base_url()."general/setup_category_listing_delete_icon/"; ?>" + id; 				
				...
				init: function () {
					...
					this_form.validate({
						...
						messages: {
														...
														category_name_1:		{ required: "Please fill this field." },
						...
						invalidHandler: function (listing, validator) {
