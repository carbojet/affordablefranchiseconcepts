        ...
        <div class="span12">
          <div style="border-color:#400000;" class="portlet box grey">
            <div style="background-color:#400000;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Discount Code</div>
            </div>
            <div class="portlet-body form">              
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url()."general/setup_discount_update"; ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $discountObj->discount_id; ?>" name="discount_id">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" class="span4 m-wrap" data-required="1" value="<?php echo $discountObj->discount_code; ?>" name="discount_code">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">Percentage (%)<span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" class="span4 m-wrap" data-required="1" value="<?php echo $discountObj->discount_percentage; ?>" name="discount_percentage">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">Expire Date <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" class="span4 m-wrap" data-required="1" value="<?php echo $discountObj->discount_expire; ?>" name="discount_expire">
                    <br>
                    <br>
