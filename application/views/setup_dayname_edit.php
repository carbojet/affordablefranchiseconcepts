        ...
        <div class="span12">
          <div style="border-color:#800000;" class="portlet box grey">
            <div style="background-color:#800000;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Day Names</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_dayname_update"); ?>" id="form" name="form">
                <input type="hidden" value="<?php echo $daynameObj->day_id; ?>" name="day_id">
                ...
                <div class="control-group">
                  <label class="control-label">Day Name (Long) <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" class="span4 m-wrap" data-required="1" value="<?php echo $daynameObj->day_name_1; ?>" name="day_name_1">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Day Name (Short) <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="<?php echo $daynameObj->day_short_1; ?>" name="day_short_1">                    
                  </div>
                </div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						ignore: "",
						rules: {
														day_name_1: 				{ required: true  },
							day_short_1: 			{ required: true  },
													},
