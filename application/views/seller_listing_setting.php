...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
        ...
        <!-- approval -->
		<?php
			$sidemenu[4] =array("1"=>"active","5"=>array("1"=>"active"));
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">Seller List Setting</h3>
				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
							...
							<div class="portlet-title" style="background-color:#7D1B7E;">
								<div class="caption"><i class="icon-edit"></i>Setup Seller Listing Properties</div>
							</div>
							...
							<div class="portlet-body form">
                            	<?php
									  ...
									  <?php } ?>
								<!-- BEGIN FORM-->
								<form action="<?php echo base_url("seller/update_seller_listing_setting/");?>" id="form" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
								<input type="hidden" name="contractor_listing_setting_id" value="<?php echo $seller_listing_settingObj->contractor_listing_setting_id;?>" />	
									...
									<div class="control-group" style="margin-top:0; margin-bottom:0">
										...
										<div class="controls">
											<h5 style="font-weight:700">Featured Contractor Time Interval For Rotation List</h5>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">In Hours<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="feature_contractor_time_span" value="<?php echo $seller_listing_settingObj->feature_contractor_time_span; ?>" data-required="1" class="span6 m-wrap" style="">
										</div>
									</div>
                                    <div class="control-group" style="margin-top:0; margin-bottom:0">
										<label class="control-label"></label>
										<div class="controls">
											<h5 style="font-weight:700">New Contractors Time Interval For Rotation List</h5>
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">In Hours<span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="new_contractor_time_span" value="<?php echo $seller_listing_settingObj->new_contractor_time_span; ?>" data-required="1" class="span6 m-wrap" style="">
										</div>
									</div>
