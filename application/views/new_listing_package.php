				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
							...
							<div class="portlet-title" style="background-color:#7D1B7E;">
								<div class="caption"><i class="icon-edit"></i> Add Listing Package</div>
							</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form name="form" id="form" method="post" class="form-horizontal" action="<?php echo base_url("seller/add_listing_package"); ?>" novalidate="novalidate">		
