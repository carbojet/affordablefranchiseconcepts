...
?>
	...
	<!--
		function confirm_delete(id, photo_listing){	
			...
			window.location = "<?php echo base_url("listing/delete_listing_photo");?>"+"/"+ id+"/"+ photo_listing; 
			return true;
		} 
		else { return false; }
		}
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption"><i class="icon-picture"></i> Manage Photos</div>
											...
											<a href="<?php echo base_url("listing/add_listing_photo/".$listingObj->listing_id);?>" class="btn small red"><i class="icon-plus"></i> Add Photo</a>
                                            <?php }?>
											</div>
										</div>
									<div class="portlet-body">
									  ...
									  <?php } ?>				
										...
										<div class="row-fluid">
                                        <?php $i=1; if(count($listing_photo)>0){foreach($listing_photo as $k=>$listing_photosObj){?>
                                        <?php if($i>=5){$i=1;?>
                                        <div style="clear:both;"></div>
										<?php }else{$i++;}?>
											...
											<div class="span3" style="margin:0; padding:10px 0 10px 0px; padding-right:30px">
												<div class="item">
													...
													<div class="details">
																												<a href="<?php echo base_url("listing/set_listing_main_photo/".$listing_photosObj->photo_id."/".$listing_photosObj->photo_listing); ?>" class="icon" title="Set As Main"><i class="icon-tag"></i></a>
																												<a href="<?php echo base_url("listing/edit_listing_photo/".$listing_photosObj->photo_id."/".$listing_photosObj->photo_listing); ?>" class="icon" title="Edit"><i class="icon-pencil"></i></a>
