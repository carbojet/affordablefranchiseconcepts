				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
							...
							<div class="portlet-title" style="background-color:#7D1B7E;">
								<div class="caption"><i class="icon-edit"></i> Add Subscription Package</div>
							</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
                                <form name="form" id="form" action="<?php echo base_url("seller/add_subscription_package"); ?>" class="form-horizontal"	method="post" enctype="multipart/form-data">
