        ...
        <div class="span12">
          <div style="border-color:#400000;" class="portlet box grey">
            <div style="background-color:#400000;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i>Edit Radius</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_radius_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $radiusObj->radius_id; ?>" name="radius_id">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="<?php echo $radiusObj->radius_name_1; ?>" name="radius_name_1">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">Value<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="<?php echo $radiusObj->radius_value; ?>" name="radius_value">
                  </div>
                </div>
