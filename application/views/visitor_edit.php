...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
		...
		<div class="page-content" data-height="1605">
				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
							...
							<div class="portlet-title" style="background-color:#800000;">
								...
								<div class="caption"><i class="icon-edit"></i> Edit Visitor</div>
							...
							<div class="portlet-body form">
								...
								<form name="form" id="form" action="<?php echo base_url("visitor/update_visitor");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">

								<input name="visitor_id" type="hidden" value="<?php echo $visitorObj->visitor_id;?>">
                                ...
                                <input name="page" type="hidden" value="<?php echo $page;?>">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<input type="text" name="visitor_username" value="<?php echo $visitorObj->visitor_username;?>" data-required="1" class="span4 m-wrap" style="" disabled="">										</div>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<input type="text" name="visitor_password" value="<?php echo $visitorObj->visitor_password;?>" data-required="1" class="span4 m-wrap" style="">
										...
										<div class="controls">
                                            ...
                                            <?php
													...
													{?>
                                                    	...
                                                    	<?php if($k==$visitorObj->visitor_title){ ?>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<input type="text" name="visitor_email" value="<?php echo $visitorObj->visitor_email;?>" data-required="1" class="span4 m-wrap" style="">
                                    ...
                                    <div class="control-group form_field">
										...
										<label class="control-label">Capital Available to invest <span class="required">*</span></label>

										<div class="controls">

											<input type="text" name="visitor_company" value="<?php echo $visitorObj->visitor_company;?>" data-required="1" class="span4 m-wrap" style="">
									...
									<div class="control-group form_field">
										...
										<label class="control-label">Estimated Net Worth <span class="required"></span></label>
									...
									<div class="control-group form_field">
										...
										<label class="control-label">Purchase Time Frame <span class="required"></span></label>
									...
									<div class="control-group form_field">
										...
										<label class="control-label">Desired Location <span class="required"></span></label>

										<div class="controls">

											<input type="text" name="visitor_website" value="<?php echo $visitorObj->visitor_website;?>" data-required="1" class="span4 m-wrap" style="">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<input type="text" name="visitor_address" value="<?php echo $visitorObj->visitor_address;?>" data-required="1" class="span4 m-wrap" style="">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<input type="text" name="visitor_address2" value="<?php echo $visitorObj->visitor_address2;?>" data-required="1" class="span4 m-wrap" style="">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
                                        <input type="text" name="visitor_zip" value="<?php echo $visitorObj->visitor_country;?>" data-required="1" class="span4 m-wrap" style="">										

										</div>

									</div>								
									<?php if(count($commentObjArray)>0){foreach($commentObjArray as $commentObj){?>
										<div class="control-group form_field">

										<label class="control-label">Ad Title <span class="required">*</span></label>

											<div class="controls">
                                            	<strong><a target="_blank" href="http://www.affordablebusinessconcepts.com/product/?listing_id=<?php echo $commentObj->listing_id;?>"><?php echo $commentObj->listing_title_1;?></a></strong>
                                        	</div>
                                        </div>
                                    ...
                                    <div class="control-group form_field">
                                        ...
                                        <textarea class="span12 m-wrap" name="comment" rows="5"><?php if(isset($commentObj->comment_description)){ echo $commentObj->comment_description; }?></textarea>										
