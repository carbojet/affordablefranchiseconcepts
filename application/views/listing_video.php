	...
	<!--
		...
		function confirm_delete(id, linkid, name){	
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				window.location = "<?php echo base_url("listing/delete_listing_video");?>"+"/"+id+"/"+linkid; 
				return true;
			} 
			else{ return false; }
		}
									...
									<div class="portlet-title">
										...
										<div class="actions">
											<div class="btn-group">
                                                ...
                                                <?php if($video_auth){?>
                                                    <li><a href="<?php echo base_url("listing/add_listing_video/".$listingObj->listing_id);?>"><i class="icon-plus"></i> Add New</a></li>
                                                <?php }?>    
                                        ...
                                        <?php if(count($listing_video)>0){ foreach($listing_video as $k=>$listing_videoObj){ ?>
											...
											<td style="padding-right:20px; vertical-align:middle">
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu">
														<li><a href="<?php echo base_url("listing/edit_listing_video/".$listing_videoObj->video_id."/".$listing_videoObj->video_type);?>"><i class="icon-edit"></i> Edit</a></li>
