...
<div class="page-container row-fluid">
  ...
  <!-- approval -->
  <?php
			$sidemenu[2] =array("1"=>"active","2"=>array("1"=>"active","2"=>array("6"=>"active")));
        ...
        <div class="span12">
          <div style="border-color:#151B54;" class="portlet box grey">
            <div style="background-color:#151B54;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Month Names</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_monthname_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $monthnameObj->month_id; ?>" name="month_id">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <h5 style="font-weight:700">English</h5>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Month Name (Long) <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="<?php echo $monthnameObj->month_name_1; ?>" name="month_name_1">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Month Name (Short) <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="<?php echo $monthnameObj->month_short_1; ?>" name="month_short_1">
                  </div>
                </div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						ignore: "",
						rules: {
														month_name_1: 				{ required: true  },
							month_short_1: 			{ required: true  },
													},
