        ...
        <div class="span12">
          <div style="border-color:#461B7E;" class="portlet box grey">
            <div style="background-color:#461B7E;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i>Edit Country</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enclocatiotype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url()."general/setup_country_update"; ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $countryObj->country_id; ?>" name="country_id">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" class="span4 m-wrap" data-required="1" value="<?php echo $countryObj->country_name; ?>" name="country_name">
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						ignore: "",
						rules: {
							country_name: 							{ required: true, minlength: 3 },
						},
						
						// custom messages for radio buttons and checkboxes
						messages: {
							country_name: 							{ required: "Please fill this field.", minlength: "Please enter at least 3 characters." },
						},
