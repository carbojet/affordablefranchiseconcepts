						...
						<div class="portlet box grey" style="border-color:#E4287C;">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
									...
									<form name="form" id="form" action="<?php echo base_url("listing/add_listing_photo/");?>" class="form-horizontal" method="post" enctype="multipart/form-data">
									<input name="photo_listing" type="hidden" value="<?php echo $listingObj->listing_id;?>">
                                        ...
                                        <input type="hidden" name="upload_limit" value="10">
