	...
	<!--
		...
		function confirm_delete_file(id){
			if ( confirm("Are you sure want to delete this video file?") ){
				window.location = "<?php echo base_url("listing/remove_own_listing_video");?>"+"/"+id; 
				return true;
			} 
			else{ return false; }
		}
								...
								<div class="control-group form_field">
									...
									<div class="controls">
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span class="checked"><input type="radio" name="video_type" value="upload" onClick="location.href='<?php echo base_url("listing/edit_own_listing_video/".$listing_videoObj->video_id."/upload/");?>'" style="opacity: 0;"></span></div>
												I want to upload video from my harddrive.
											</label>
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="external" checked="checked" onClick="location.href='<?php echo base_url("listing/edit_own_listing_video/".$listing_videoObj->video_id."/external/");?>'" style="opacity: 0;"></span></div>
