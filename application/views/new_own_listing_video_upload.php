									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<label class="radio line">
												<div class="radio" id="uniform-undefined"><span class="checked"><input type="radio" name="video_type" value="upload" checked="checked" onClick="location.href='<?php echo base_url("listing/add_own_listing_video/".$listingObj->listing_id."/upload/");?>'" style="opacity: 0;"></span></div>
