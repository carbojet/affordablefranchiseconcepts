				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
							...
							<div class="portlet-title" style="background-color:#151B54;">
								<div class="caption"><i class="icon-edit"></i>Edit 2CheckOut Settings</div>
							</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("sitesetup/update_payment_preference/");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
								<input name="payment_id" type="hidden" value="<?php echo $paymnet_preferenceObj->payment_id;?>">
									...
									<div class="control-group">
										...
										<div class="controls" style="max-width:500px">
											<p>If you use 2Checkout Payment System, then your customers will be able<br>to pay you using their credit cards such as Visa, MasterCard, AMEX and JCB.<br><br>To completely use 2CheckOut, you will need to register with 2CheckOut.com<br>and then enter your 2CO ID Number bellow. When your website is ready,<br>please set your 2CO Mode to REAL MODE.<br><br>Also, do not forget to set your 2CO account to work with the website.<br>Please click here to get more information on how to integrate your 2CO account.</p>
										</div>
									</div>
									<div class="space20"></div>
									<div class="control-group form_field">
										<label class="control-label">2CO ID Number <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="payment_link" value="<?php echo $paymnet_preferenceObj->payment_link;?>" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">2CO Mode <span class="required">*</span></label>
										<div class="controls">
											<select name="payment_mode" class="m-wrap span4">
											<option value="demo" selected="">Demo Mode</option>
											<option value="real">Real Mode</option>
											</select>												
										</div>
									</div>
									<div class="form-actions">
										<button type="submit" class="btn black" style="background-color:#151B54;"><i class="icon-ok"></i> Save</button>
									</div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						messages: {
							email_name: 				{ required: "Please fill this field." },
							email_subject: 				{ required: "Please fill this field." },
						},
