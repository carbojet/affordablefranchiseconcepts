			...
			<div class="container-fluid">
				...
				<div class="row-fluid profile">
					<div class="span12">
						...
						?>
						<!--BEGIN TABS-->
						<div class="portlet box grey" style="border-color:#E4287C;">
							<div class="portlet-title" style="background-color:#E4287C;">
								<div class="caption"><i class="icon-picture"></i>Add Photos</div>
							</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
									...
									<form name="form" id="form" action="<?php echo base_url("listing/add_own_listing_photo/");?>" class="form-horizontal" method="post" enctype="multipart/form-data">
									<input name="photo_listing" type="hidden" value="<?php echo $listingObj->listing_id;?>">
										...
										<?php
										$remain_upload = count($this->Listingdb->listing_photos(array("photo_listing"=>$listingObj->listing_id)))+1;										
										if(!is_object($packageObj)){$upload_limit = 1;}
										else{$upload_limit = $packageObj->package_listing_pics;}?>
										<input type="hidden" name="upload_loop" value="<?php echo $remain_upload; ?>">
                                        <input type="hidden" name="upload_limit" value="<?php echo $upload_limit;?>">
										<?php for($i=$remain_upload;$i<=$upload_limit;$i++){?>
										<div class="space20"></div>
										<div class="space20"></div>
										<div class="control-group" style="margin-top:0; margin-bottom:0">
											<label class="control-label"></label>
											<div class="controls">
												<h5 style="font-weight:700">Photo # <?php echo $i;?></h5>
											</div>
										</div>
											...
											<div class="controls">
												<div class="fileupload fileupload-new" data-provides="fileupload">
													...
													<div>
														...
														<input name="photo_file_<?php echo $i;?>" type="file" class="default"></span>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="photo_caption_1_<?php echo $i;?>" value="" data-required="1" class="span5 m-wrap" style="">
											</div>
										</div>
										<?php }?>
									<div class="form-actions">
										<button type="submit" class="btn black" style="background-color:#E4287C;"><i class="icon-ok"></i> Save</button>
									</div>
