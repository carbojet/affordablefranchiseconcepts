...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
        ...
        <!-- approval -->
		<?php
			$sidemenu[6] =array("1"=>"active","2"=>array("1"=>"active"));
									  ...
									  <?php } ?>
										...
										<tbody>
											...
											<td style="vertical-align:middle;">
												...
												?>
												Package : <?php if(is_object($packObj)){ echo $package=$packObj->package_listing_name_1;}?>
						...
						<div style="padding-bottom:50px">
							<div class="control-group" style="float:left">
								<div class="controls" style="font-weight:bold">
									...
									<form name="pagination" action="<?php echo base_url("payment/all_payments/");?>" method="post">
