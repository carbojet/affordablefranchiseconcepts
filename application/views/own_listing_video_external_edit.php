					...
					<div class="span12">
						...
						<div class="portlet box grey" style="border-color:#9F000F;">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("listing/upload_own_listing_video/");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
							...
							<div class="space20"></div>
								...
								<div class="control-group" style="margin-top:10px">
									...
									<div class="controls">
										<!--<a onclick="preview('8');" class="btn mini purple" style="cursor:pointer"><i class="icon-zoom-in"></i> Preview Video</a> &nbsp;&nbsp;|&nbsp;&nbsp;-->
