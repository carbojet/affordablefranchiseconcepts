        ...
        <div class="span12">
          <div class="portlet box grey" style="border-color:#800000;">
            <div class="portlet-title" style="background-color:#800000;">
              <div class="caption"> <i class="icon-edit"></i> Edit Banner</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form name="form" id="form" action="<?php echo base_url('pages/editbanner/');?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                ...
                <div class="control-group">
                  <label class="control-label">Slider Title<span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" name="banner_title" value="" data-required="1" class="span5 m-wrap">
                  </div>
                </div>                
                <div class="control-group form_field">
                  <label class="control-label">Banner Desc </label>
                  <div class="controls">
                    <input type="text" name="img_alt" data-required="1" class="span6 m-wrap" style="">					
                  </div>
                </div>
				<div class="control-group form_field">
					...
					<div class="fileupload fileupload-new" data-provides="fileupload">
						<div>
							<span class="btn btn-file">
								...
								<input name="media_image" type="file" class="default">
							</span>
                ...
                <div class="form-actions">
                  <button type="submit" class="btn black" style="background-color:#800000;" name="media_new"><i class="icon-ok"></i> Save</button>
                </div>
              </form>
              <!-- END FORM-->
            </div>
