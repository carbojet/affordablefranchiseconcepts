				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
							...
							<div class="portlet-title" style="background-color:#400000;">
								<div class="caption"><i class="icon-comments"></i> Add Review / Comment - Step 1 of 3</div>
							</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("listing/new_review_step_2/");?>" class="form-horizontal" method="post">
								<input name="comment_linkid" type="hidden" value="<?php echo $reviewObj->comment_linkid;?>">                                																		
									...
									<div class="control-group">
										...
										<div class="controls">
											<div class="span8">
											To add a review or comment, please search the visitor account you want for this review first. You can use the following search form to start the search process
											</div>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="search_username" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">First Name		</label>
										<div class="controls">
											<input type="text" name="search_firstname" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">Last Name		</label>
										<div class="controls">
											<input type="text" name="search_lastname" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="form-actions">
										<button type="submit" class="btn black" style="background-color:#400000;"><i class="icon-search"></i> Search</button>
									</div>
