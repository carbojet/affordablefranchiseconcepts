	...
	<!--
		...
		function confirm_delete(id, linkid, name){	
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				window.location = "<?php echo base_url("listing/delete_seller_listing_category");?>"+"/"+id+"/"+linkid; 
				return true;
			} 
			else{ return false; }
		}
							...
							<div class="span12">
								...
								<div class="portlet">
									<div class="portlet-title">
										...
										<div class="actions">
											<a href="<?php echo base_url("listing/add_seller_listing_category/".$listingObj->listing_id);?>" class="btn red"><i class="icon-plus"></i> Add New</a>																						
									  </div>
                                      <?php }?>
									</div>
									  ...
									  <?php } ?>
										...
										<tr>
											<td style="padding-right:20px; vertical-align:middle">
												<h5 style="font-weight:700; margin:0"><?php echo $listing_categoryObj->category_name_1;?></h5>
												<?php echo $listing_categoryObj->category_name_1;?>
											</td>
											<td style="text-align:right; vertical-align:middle; padding:10px;">
                                            <?php if(!$category_auth){?>
                                            	<a class="btn mini yellow" onClick="confirm_delete('<?php echo $listing_categoryObj->category_id;?>','<?php echo $listingObj->listing_id;?>','<?php echo $listing_categoryObj->category_name_1;?>')" style="cursor:pointer"><i class="icon-trash"></i> Delete</a>
                                            <?php }?>
											</td>
										</tr>
                                        <?php }?>
