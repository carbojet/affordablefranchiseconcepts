...
<div class="page-container row-fluid">
  ...
  ?>
  <!-- BEGIN PAGE -->
  <div class="page-content" data-height="918" style="">
        ...
        <div class="span12">
          <div style="border-color:#400000;" class="portlet box grey">
            <div style="background-color:#400000;" class="portlet-title">
              <div class="caption"> <i class="icon-edit"></i> Add Listing Category </div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_category_listing_add"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="" name="category_parent">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="" name="category_name_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                ...
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="" name="category_url_1">
                    <input type="hidden" value="none" name="required_category_url_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                ...
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="" name="category_desc_1">
                    <input type="hidden" value="none" name="required_category_desc_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                ...
                <div style="margin-top:0; padding-top:0" class="control-group">
                  ...
                  <div class="controls"> <span class="label label-important">Note :</span> <span>Please only upload JPG or JPEG file only ...</span> <br>
                    You can upload an image, picture or icon for this category. </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>-->
