					...
					<div class="span12">						
						<div class="portlet box grey" style="border-color:#493D26;">
							<div class="portlet-title" style="background-color:#493D26;">
								<div class="caption"><i class="icon-edit"></i>Edit Email Template (English)</div>
							</div>
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("sitesetup/update_email_template/");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
								<input name="email_id" type="hidden" value="<?php echo $mail_templateObj->email_id;?>">																			
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<input type="text" name="email_name_1" value="<?php echo $mail_templateObj->email_name_1;?>" data-required="1" class="span8 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Subject <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="email_subject_1" value="<?php echo $mail_templateObj->email_subject_1;?>" data-required="1" class="span8 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Content <span class="required"></span></label>
										<div class="controls">
											<textarea name="email_content_1" id="email_content_1" class="span8 ckeditor m-wrap" rows="20" style="visibility: hidden; display: none;"><?php echo $mail_templateObj->email_content_1;?></textarea>
                                            <div id="cke_email_content" class="cke_1 cke cke_reset cke_chrome cke_editor_email_content cke_ltr cke_browser_webkit" dir="ltr" lang="en" role="application" aria-labelledby="cke_email_content_arialbl"></div>
										</div>
									</div>
