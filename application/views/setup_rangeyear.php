      ...
      <div class="row-fluid profile">
        <div class="span12">
            ...
            <div class="span12">
              ...
              <div class="portlet">
                <div class="portlet-title">
                  <div class="caption"><i class="icon-cogs"></i> Manage Year Range</div>
                  <div class="actions">
                    <div class="btn-group">
                      <button data-toggle="dropdown" class="btn red dropdown-toggle">Add New <i class="icon-angle-down"></i></button>
                      <ul class="dropdown-menu pull-right">
                        <li><a href="<?php echo base_url("general/setup_rangeyear_add"); ?>"><i class="icon-plus"></i> Add New</a></li>
                        <li><a style="cursor:pointer" onclick="confirm_delete_all('Manage Year Range')"><i class="icon-trash"></i> Delete All</a></li>
                        <li><a style="cursor:pointer" onclick="confirm_delete_selected('Manage Year Range')"><i class="icon-remove"></i> Delete Selected</a></li>
                        <li><a style="cursor:pointer" onclick="confirm_restore_default('Manage Year Range')"><i class="icon-refresh"></i> Restore Default</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
				...
				if(isset($success_msg))
                  ...
                  <?php } ?>
                  <form action="system_setup_rangeyear_update.php" method="post" name="form">
                    ...
                    <table id="sample_1" class="table table-bordered table-advance table-hover">
                      ...
                      <tbody>
                      	<?php if(count($rangeyear_list)>0){ foreach($rangeyear_list as $k=>$rangeyearObj){ ?>
                        <tr>
                          <td style="padding-top:8px"><div class="checker" id="uniform-undefined"><span class="">
                              <input type="checkbox" value="yes" class="checkboxes" name="rangeyear_status_delete_12" style="opacity: 0;">
                              </span></div></td>
                          <td style="padding-right:20px"><h5 style="font-weight:700; margin:0"><?php echo $rangeyearObj->rangeyear_value; ?></h5></td>
                          <td style="text-align:right"><div style="text-align:left" class="btn-group"> <a href="#" data-toggle="dropdown" class="btn mini yellow dropdown-toggle">Edit <i class="icon-angle-down"></i></a>
                              <ul class="dropdown-menu pull-right">
                                <li><a href="<?php echo base_url("general/setup_rangeyear_edit/".$rangeyearObj->rangeyear_id); ?>"><i class="icon-edit"></i> Edit</a></li>
                                <li><a style="cursor:pointer" onclick="confirm_delete('<?php echo $rangeyearObj->rangeyear_id; ?>','<?php echo $rangeyearObj->rangeyear_value; ?>')"><i class="icon-trash"></i> Delete</a></li>
                              </ul>
                            </div></td>
                        </tr>
                        <?php } } ?>
          ...
          <div style="padding-bottom:50px">
            <div style="float:right;"> <a class="btn mini red" style="cursor:pointer; width:100px; margin-bottom:7px; text-align:left" onclick="confirm_delete_selected('Manage Year Range')"><i class="icon-remove"></i> Delete Selected</a> </div>
...
<script type="text/javascript">
		...
		function confirm_delete(id, name){	
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				window.location = "<?php echo base_url()."general/delete_setup_rangeyear/"; ?>" + id; 
				return true;
			} 
			else{ return false; }
		}
