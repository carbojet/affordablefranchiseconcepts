        ...
        <div class="span12">
          <div style="border-color:#461B7E;" class="portlet box grey">
            <div style="background-color:#461B7E;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i>Edit Year</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_rangeyear_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $rangeyearObj->rangeyear_id; ?>" name="rangeyear_id">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="<?php echo $rangeyearObj->rangeyear_value; ?>" name="rangeyear_value">
                  </div>
                </div>
