								...
								<div class="control-group form_field">
									...
									<div class="controls">
                                        <label class="radio line">
                                            <div class="radio" id="uniform-undefined"><span class="checked"><input type="radio" name="video_type" value="upload" checked="checked" onClick="location.href='<?php echo base_url("listing/edit_listing_video/".$listing_videoObj->video_id."/upload/");?>'" style="opacity: 0;"></span></div>
                                            I want to upload video from my harddrive.
                                        </label>
                                        <label class="radio line">
                                            <div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="external" onClick="location.href='<?php echo base_url("listing/edit_listing_video/".$listing_videoObj->video_id."/external/");?>'" style="opacity: 0;"></span></div>
