		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="tiles" style="max-width:300px; height:600px">
										...
										<div class="tile" style="background-color:#C12869;" onClick="location.href='<?php echo base_url("visitors/visitor_profile_edit/");?>'">
						<div class="tile-body">
							<i class="icon-user"></i>
						</div>
					...
					<div class="tile" style="background-color:#C12869;" onclick="location.href='<?php echo base_url("visitors/visitor_favourite/");?>'">
						<div class="tile-body">
					...
					<div class="tile" style="background-color:#151B54;" onclick="location.href='<?php echo base_url("visitors/visitor_reviews/");?>'">
						<div class="tile-body">
						...
						<div class="tile-object" style="text-align:center">
							My Reviews
										...
										<div class="tile" style="background-color:#151B54;" onClick="location.href='<?php echo base_url("visitors/visitor_profile_password/");?>'">
						<div class="tile-body">
							<i class="icon-key"></i>
						</div>
						<div class="tile-object" style="text-align:center">
					...
					<div class="tile" style="background-color:#493D26;" onClick="location.href='<?php echo base_url("visitor/logout/");?>'">
						<div class="tile-body">
							<i class="icon-off"></i>
						</div>
						<div class="tile-object" style="text-align:center">
