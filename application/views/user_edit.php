					...
					<div class="span12">						
						<div class="portlet box grey" style="border-color:#7D1B7E;">
							...
							<div class="portlet-title" style="background-color:#7D1B7E;">
								<div class="caption"><i class="icon-edit"></i> Edit User</div>
							</div>							
							
							<div class="portlet-body form">							
								
								<!-- BEGIN FORM-->
								<form action="<?php echo base_url("/user/update/"); ?>" id="form" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                	<input type="hidden" name="user_id" value="<?php echo $userObj->user_id; ?>" />
                                    <!--alert box -->
									<?php
                                        if(isset($validation_errors))
                                        {?>
                                            <div class="alert alert-error hide" style="margin: 10px 0px; display: block;">
                                  ...
                                  <?php } ?>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<input type="text" name="user_username" value="<?php echo $userObj->user_username; ?>" data-required="1" class="span3 m-wrap" readonly="readonly">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Password <span class="required">*</span></label>
										<div class="controls">
											<input type="password" name="user_password" value="<?php echo $userObj->user_password; ?>" data-required="1" class="span3 m-wrap">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">First Name <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="user_firstname" value="<?php echo $userObj->user_firstname; ?>" data-required="1" class="span5 m-wrap">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Last Name <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="user_lastname" value="<?php echo $userObj->user_lastname; ?>" data-required="1" class="span5 m-wrap">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Email Address <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="user_email" value="<?php echo $userObj->user_email; ?>" data-required="1" class="span5 m-wrap" >
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Access Type <span class="required"></span></label>
										<div class="controls">
											<select name="user_type" class="m-wrap span5">
                                            <?php
												$temp_array = array("full"=>"Full Access","limited"=>"Limited Access");
												foreach($temp_array as $k=>$v)
												{
													if($userObj->user_type==$k)
													{
														?>
											...
											<input type="hidden" name="required_user_type" value="text">										  
										</div>
									</div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						ignore: "",
						rules: {
							user_username: 				{ required: true, minlength: 3, remote: "system_user_check_username.php" },
							user_password: 				{ required: true, minlength: 3 },
							user_firstname: 			{ required: true, minlength: 3 },
							user_lastname: 				{ required: true, minlength: 3 },
						...
						messages: {
							user_username: 				{ required: "Please fill this field.", minlength: "Please enter at least 3 characters.",	remote: "The username you choose is not available.." },
							user_password: 				{ required: "Please fill this field.", minlength: "Please enter at least 3 characters."	},
							user_firstname: 			{ required: "Please fill this field.", minlength: "Please enter at least 3 characters."	},
							user_lastname: 				{ required: "Please fill this field.", minlength: "Please enter at least 3 characters."	},
							user_email: 				{ required: "Please fill this field.", email: "Please enter a valid email address."  			},
							user_type: 					{ required: "Please fill this field."  },
						},
