...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
        ...
        <!-- approval -->
		<?php
			$sidemenu[8] =array("1"=>"active","2"=>array("3"=>"active"));
							...
							<div class="span12">
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption"><i class="icon-list"></i> Approve Listings</div>
										<div class="actions">
											<div class="btn-group">
												<button class="btn red dropdown-toggle" data-toggle="dropdown">Approve All <i class="icon-angle-down"></i></button>
												<ul class="dropdown-menu pull-right">
													<li><a onClick="confirm_approve_all('Approve Listings','%2Fdirectory%2Fadmin%2Fapprove_listing.php')" style="cursor:pointer"><i class="icon-thumbs-up"></i> Approve All</a></li>
													<li><a onClick="confirm_approve_selected('Approve Listings')" style="cursor:pointer"><i class="icon-thumbs-up"></i> Approve Selected</a></li>
													<li><a onClick="confirm_reject_all('Approve Listings','%2Fdirectory%2Fadmin%2Fapprove_listing.php')" style="cursor:pointer"><i class="icon-thumbs-down"></i> Reject All</a></li>
													<li><a onClick="confirm_reject_selected('Approve Listings')" style="cursor:pointer"><i class="icon-thumbs-down"></i> Reject Selected</a></li>
												</ul>
											</div>
									  </div>
									</div>
									<div class="portlet-body">
										...
										<form name="form" method="post" action="system_approve_listing_update.php">
										<input name="form_action" type="hidden">
										<input name="backurl" type="hidden" value="%2Fdirectory%2Fadmin%2Fapprove_listing.php">
