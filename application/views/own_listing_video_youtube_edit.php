					...
					<div class="span12">
						...
						<div class="portlet box grey" style="border-color:#9F000F;">
							...
							<div class="portlet-body form">
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("listing/update_own_listing_video/");?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                <input type="hidden" name="video_type" value="<?php echo $listing_videoObj->video_type;?>">
                                <input type="hidden" name="video_id" value="<?php echo $listing_videoObj->video_id;?>">
								...
								<div class="control-group form_field">
									...
									<div class="controls">
                                        <label class="radio line">
                                            <div class="radio" id="uniform-undefined"><span class="checked"><input type="radio" name="video_type" value="upload" checked="checked" onClick="location.href='<?php echo base_url("listing/edit_own_listing_video/".$listing_videoObj->video_id."/upload/");?>'" style="opacity: 0;"></span></div>
                                            I want to upload video from my harddrive.
                                        </label>
                                        <label class="radio line">
                                            <div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="external" onClick="location.href='<?php echo base_url("listing/edit_own_listing_video/".$listing_videoObj->video_id."/external/");?>'" style="opacity: 0;"></span></div>
                                            I want to link to external video url.
                                        </label>
                                        <label class="radio line">
                                            <div class="radio" id="uniform-undefined"><span><input type="radio" name="video_type" value="youtube" onClick="location.href='<?php echo base_url("listing/edit_own_listing_video/".$listing_videoObj->video_id."/youtube/");?>'" style="opacity: 0;"></span></div>
								...
								<div class="control-group form_field">
										...
										<div class="controls">
			                                <textarea name="video_youtube" class="span8 m-wrap" rows="5"><?php echo $listing_videoObj->video_youtube; ?></textarea>
										</div>
									</div>
							<div class="space20"></div>
							<div class="space20"></div>
									...
									<div class="controls">
										<div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden">
											<div class="fileupload-new thumbnail" style="max-width: 200px; max-height: 150px;">
												<img src="<?php echo base_url("/video_small/".$listing_videoObj->video_id.".jpg");?>" border="0">
											</div>
