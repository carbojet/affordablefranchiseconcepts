	...
	<div class="page-lock">
		...
		<div class="page-body" style="padding-top:20px">
			...
			<div class="page-lock-info">			
				...
				<form class="form-search" method="post" action="<?php echo base_url(); ?>seller_login/access" style="margin-top:10px">
                    <div class="input-append" style="margin-bottom:5px;">
                        <div class="input-icon left">
                            <i class="icon-user"></i>
                            <input type="text" name="seller_username"	value="" placeholder="Username"	class="m-wrap placeholder-no-fix" style="padding-right:20px !important;"/>
                    ...
                    <div class="input-append" style="margin-bottom:5px">
                        <div class="input-icon left">
                            <i class="icon-lock"></i>
                            <input type="password" 	name="seller_password" value="" placeholder="Password" class="m-wrap placeholder-no-fix" style="padding-right:20px !important;"/>
