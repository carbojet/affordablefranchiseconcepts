...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
		...
		<?php
			...
			//$current_date = date(date('Y-m-d'),strtotime('+1 month'));
			...
			<div class="container-fluid">
				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
												...
												<div class="portlet box grey" style="border-color:#C12869;">
							<div class="portlet-title" style="background-color:#C12869;">
								<div class="caption"><i class="icon-edit"></i> Add Seller</div>
							</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form name="form" id="form" action="<?php echo base_url("seller/new_seller"); ?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">					
									...
									<div class="control-group" style="margin-top:0; margin-bottom:0">
										...
										<div class="controls">
											<h5 style="font-weight:700">Account Info</h5>
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Username <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="seller_username" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Password <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="seller_password" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="space20"></div>
									<input type="hidden" name="seller_language" value="1">
									<div class="control-group form_field">
										<label class="control-label">Package <span class="required"></span></label>
										<div class="controls">
											<select name="seller_package" class="m-wrap span4">
											<option value="0" selected="selected">Pay Per Listing</option>
                                            <option value="1">Lite</option>
                                            </select>
										</div>
									</div>
									<div class="control-group form_field" style="margin-bottom:0">
										<label class="control-label">Payment Period <span class="required"></span></label>
										<div class="controls">
											<select name="seller_payment_period" class="m-wrap span4">
											<option value="monthly">Monthly</option>
											<option value="quarterly">3 Months</option>
											<option value="semiannually">6 Months</option>
											<option value="annually">12 Months</option>
											</select>
										</div>
									</div>
									<div class="control-group" style="margin-top:0;">
										<label class="control-label"></label>
										<div class="controls">
											Payment period will be used for<br>pay-per-month (subscription) packages ...
										</div>
									</div>
									<div class="space20"></div>
									<div class="control-group form_field" style="margin-bottom:0">
										...
										<div class="controls">
											<input type="text" name="seller_expire_date" value="<?php if(!empty($current_date)){echo $current_date;} ?>" data-required="1" class="span4 m-wrap" readonly>
										</div>
									</div>
									<div class="control-group" style="margin-top:0;">
										<label class="control-label"></label>
										<div class="controls">
											You can determine the expiration date of this seller manually.<br>
											Just enter the date in the following YYYY-MM-DD format.<br>
											Example : 2012-01-31 for January 31st, 2012
											<br><br>
											Also you must understand that by extending the expiration date<br>will give pro-rate credit to this seller account if the seller<br>upgrades later.
										</div>
									</div>
									<div class="space20"></div>
									<div class="control-group" style="margin-top:0; margin-bottom:0">
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<input type="text" name="seller_firstname" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Last Name <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="seller_lastname" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Phone Number <span class="required"></span></label>
										<div class="controls">
											<input type="text" name="seller_phone" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Mobile Number <span class="required"></span></label>
										<div class="controls">
											<input type="text" name="seller_mobile" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Fax Number <span class="required"></span></label>
										<div class="controls">
											<input type="text" name="seller_fax" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Email <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="seller_email" value="" data-required="1" class="span6 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Website URL <span class="required"></span></label>
										<div class="controls">
											<input type="text" name="seller_website" value="http://www." data-required="1" class="span6 m-wrap" style="">
                                            <p>
                                            	Please follow format ( http://www.domain.com )
                                            </p>
										</div>
									</div>
									<div class="space20"></div>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<input type="text" name="seller_address" value="" data-required="1" class="span6 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label"></label>
										<div class="controls">
											<input type="text" name="seller_address2" value="" data-required="1" class="span6 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">City / Town <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="seller_city" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">State / Province <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="seller_province" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">ZIP / Post Code <span class="required">*</span></label>
										<div class="controls">
											<input type="text" name="seller_zip" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									<div class="control-group form_field">
										...
										<div class="controls">
											...
											<select name="seller_country" class="m-wrap span6">
												<?php
													foreach($countryObjArray as $k=>$countryObj)
													{?>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<label class="radio">
												<div class="radio" id="uniform-undefined"><span class="checked"><input name="seller_type" type="radio" value="personal" checked="true" onClick="document.form.seller_company.value='';" style="opacity: 0;"></span></div>
												Personal
											</label>
											<br>
											<label class="radio">
												<div class="radio" id="uniform-undefined"><span><input name="seller_type" type="radio" value="company" style="opacity: 0;"></span></div>
												Company
											</label>
											<input type="hidden" name="required_seller_type" value="none">
										</div>
									</div>
									<div class="control-group form_field">
										<label class="control-label">Company Name <span class="required"></span></label>
										<div class="controls">
											<input type="text" name="seller_company" value="" data-required="1" class="span4 m-wrap" style="">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="seller_desc_1" class="span8 m-wrap" rows="6"></textarea>
										</div>
									</div>
																		<div class="space20"></div>
									...
									<div class="form-actions">
										<button type="submit" class="btn black" style="background-color:#C12869;"><i class="icon-ok"></i> Save</button>
									</div>
...
?>
	...
	<!-- BEGIN CORE PLUGINS -->
	<script src="<?php echo base_url(); ?>theme/plugins/jquery-1.8.3.min.js" type="text/javascript"></script>   
	<!-- IMPORTANT! Load jquery-ui-1.10.1.custom.min.js before bootstrap.min.js to fix bootstrap tooltip conflict with jquery ui tooltip -->  
	<script src="<?php echo base_url(); ?>theme/plugins/jquery-ui/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>      
	<script src="<?php echo base_url(); ?>theme/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
	<!--[if lt IE 9]>
	<script src="gui/ltr/plugins/excanvas.js"></script>
	<script src="gui/ltr/plugins/respond.js"></script>  
	<![endif]-->   
	<script src="<?php echo base_url(); ?>theme/plugins/breakpoints/breakpoints.js" type="text/javascript"></script>  
	<!-- IMPORTANT! jquery.slimscroll.min.js depends on jquery-ui-1.10.1.custom.min.js --> 
	<!-- this is important for forms -->
	<script src="<?php echo base_url(); ?>theme/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
	<script src="<?php echo base_url(); ?>theme/plugins/jquery.blockui.js" type="text/javascript"></script>  
	<script src="<?php echo base_url(); ?>theme/plugins/jquery.cookie.js" type="text/javascript"></script>

	<script src="<?php echo base_url(); ?>theme/plugins/uniform/jquery.uniform.min.js" type="text/javascript" ></script> 
	<!-- END CORE PLUGINS -->
