        ...
        <div class="span12">
          <div class="portlet box grey" style="border-color:#800000;">
            <div class="portlet-title" style="background-color:#800000;">
              <div class="caption"> <i class="icon-edit"></i> Create New Testimonial</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form name="form" id="form" action="<?php echo base_url('pages/addtestimonial/');?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">					
                    ...
                    <input name="tss_image" type="text" data-required="1" class="span12 m-wrap" placeholder="image url">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="tss_name" class="span12 m-wrap" />
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <textarea name="tss_testimonial" class="span8 ckeditor m-wrap" rows="6" style="visibility: hidden; display: none;"></textarea>
