  ...
  <div class="page-content" data-height="860" style="">
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid inbox">
        <div class="span12">
          <div style="border-color:#461B7E;" class="portlet box grey">
            <div style="background-color:#461B7E;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i>Add Country</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" id="form" action="<?php echo base_url()."general/setup_country_add" ?>">
                ...
                <div class="control-group">
                  <label class="control-label">Country Name 1 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name1">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 2 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name2">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 3 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name3">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 4 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name4">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 5 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name5">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 6 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name6">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 7 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name7">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 8 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name8">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 9 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name9">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Country Name 10 <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span6 m-wrap" data-required="1" value="" name="country_name10">
                  </div>
                </div>
                <div class="form-actions">
                  <button style="background-color:#461B7E;" class="btn black" type="submit"><i class="icon-ok"></i> Save</button>
                </div>
              </form>
              <!-- END FORM-->
            </div>
