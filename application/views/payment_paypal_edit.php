								...
								<input name="payment_id" type="hidden" value="<?php echo $paymnet_preferenceObj->payment_id;?>">
									...
									<div class="control-group">
										...
										<div class="controls" style="max-width:500px">
											<p>If you use Paypal, your customers can submit their payment easily using<br>their own paypal account. Once the purchase is paid, the system will<br>automatically store and process the payment.<br><br><br>To completely use Paypal, you will need to register with paypal.com and<br>then enter your paypal email address bellow.</p>
										</div>
									</div>
									<div class="space20"></div>
