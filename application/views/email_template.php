...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
        ...
        <!-- approval -->
		<?php
			$sidemenu[1] =array("1"=>"active","2"=>array("7"=>"active"));
							...
							<div class="span12">
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption"><i class="icon-cogs"></i>Manage Email Templates</div>
										<div class="actions">
											<a class="btn small red" onClick="confirm_restore_default('Email Template')" style="cursor:pointer"><i class="icon-refresh"></i> Restore Default</a>
										</div>
									</div>
									<div class="portlet-body">
										...
										<form name="form" method="post" action="<?php echo base_url("sitesetup/update_all_mail_templates/");?>">
										<table class="table table-bordered table-advance table-hover" id="sample_1">
										<thead>
										<tr>
											<th class="span7">Email Template</th>
											<th class="hidden-480" width="150" style="text-align:center">Last Update</th>
											<th class="span3"></th>
										</tr>
										</thead>
										<tbody>
                                        <?php foreach($mail_template_list as $mail_templateObj){?>
										<tr>
											<td style="vertical-align:middle; padding-top:13px">
												<h5 style="font-weight:700; margin:0; padding-bottom:0"><?php echo $mail_templateObj->email_name_1;?></h5>
												<a class="btn mini yellow" href="<?php echo base_url("sitesetup/email_template_edit/".$mail_templateObj->email_id);?>"> Edit</a>
											</td>
											<td class="hidden-480" style="vertical-align:middle; text-align:center"><?php echo date("d M Y",strtotime($mail_templateObj->email_last_update));?></td>
											<td style="text-align:right; vertical-align:middle">
												<div class="control-group">
													<div class="controls">
														<div class="basic-toggle-button toggle-button" style="width: 100px; height: 25px;">
                                                        	<?php
														if($mail_templateObj->email_status=="yes"){?>
														<div style="left: 0px; width: 150px;">
                                                        	<input type="hidden" name="email_id[]" value="<?php echo $mail_templateObj->email_id; ?>">
                                                            <input type="hidden" name="email_status_val[]" value="<?php echo $mail_templateObj->email_status; ?>" class="toggleval">
                                                        	<input name="email_status[]" value="<?php echo $mail_templateObj->email_status;?>" type="checkbox" class="toggle" checked="checked" >
													...
													<?php }else{?>
														<div style="left:-50%; width: 150px;">
                                                        	<input type="hidden" name="email_id[]" value="<?php echo $mail_templateObj->email_id; ?>">
                                                            <input type="hidden" name="email_status_val[]" value="<?php echo $mail_templateObj->email_status; ?>" class="toggleval">
                                                        	<input name="email_status[]" value="<?php echo $mail_templateObj->email_status;?>" type="checkbox" class="toggle">
                                                            <span class="labelLeft" style="width: 50px; height: 25px; line-height: 25px;">ON</span><label style="width: 50px; height: 25px;"></label>
                                                            <span class="labelRight" style="width: 50px; height: 25px; line-height: 25px;">OFF </span>
                                                        </div>
													<?php }?>
