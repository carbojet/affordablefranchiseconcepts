        ...
        <div class="span12">
          <div style="border-color:#151B54;" class="portlet box grey">
            <div style="background-color:#151B54;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Title</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_title_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $titleObj->title_id; ?>" name="title_id">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" class="span4 m-wrap" data-required="1" value="<?php echo $titleObj->title_name_1; ?>" name="title_name_1">
                  </div>
                </div>
			...
			return {
				...
				init: function () {
					...
					this_form.validate({
						...
						ignore: "",
						rules: {
														title_name_1: 		{ required: true, minlength: 3 },
													},
						
						// custom messages for radio buttons and checkboxes
						messages: {
														title_name_1: 		{ required: "Please fill this field.", minlength: "Please enter at least 3 characters." },
													},
