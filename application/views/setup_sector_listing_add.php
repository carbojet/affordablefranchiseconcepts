        ...
        <div class="span12">
          <div style="border-color:#400000;" class="portlet box grey">
            <div style="background-color:#400000;" class="portlet-title">
              <div class="caption"> <i class="icon-edit"></i> Add Listing Sector </div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_sector_listing_add"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="0" name="sector_parent">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="" name="sector_name_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                ...
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="" name="sector_url_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                ...
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <textarea class="span8 m-wrap" rows="6" name="sector_desc_1"></textarea>
                  </div>
                </div>
                <div class="space10"></div>
                ...
                <div class="control-group" style="margin-bottom:0;">
                  ...
                  <div class="controls">
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail" style="max-width: 200px; max-height: 150px;"> <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image" alt=""> </div>
