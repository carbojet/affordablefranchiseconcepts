...
<div class="page-container row-fluid">
  ...
  ?>
  <!-- BEGIN PAGE -->
  <div class="page-content" data-height="909" style="">
            ...
            <div class="span12">
              ...
              <div class="portlet">
                <div class="portlet-title">
                  <div class="caption"><i class="icon-cogs"></i> Manage Month Names</div>
                  <div class="actions">
                    <div class="btn-group">
                      <button data-toggle="dropdown" class="btn red dropdown-toggle">Tools <i class="icon-angle-down"></i></button>
                      <ul class="dropdown-menu pull-right">
                        <li><a style="cursor:pointer" onClick="confirm_restore_default('Manage Month Names')"><i class="icon-refresh"></i> Restore Default</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
				...
				if(isset($success_msg))
                  ...
                  <table id="sample_1" class="table table-bordered table-advance table-hover">
                    ...
                    <tbody>
                    	<?php if(count($monthname_list)>0){ foreach($monthname_list as $k=>$monthnameObj){ ?>                      	
                      		<tr>
                                <td style="padding-right:20px"><h5 style="font-weight:700; margin:0"><?php echo $monthnameObj->month_name_1." / ".$monthnameObj->month_short_1;?></h5>
                                  <a href="<?php echo base_url("general/setup_monthname_edit/".$monthnameObj->month_id); ?>" class="btn mini yellow">Edit</a> </td>
                                <td style="text-align:right"> <?php echo $monthnameObj->month_order; ?> </td>
                      		</tr>
                      	<?php } } ?>
                    </tbody>
                  </table>
...
<script type="text/javascript">
		...
		function confirm_delete(id, name){	
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				window.location = "<?php echo base_url()."general/delete_setup_location/"; ?>" + id; 
				return true;
			} 
			else{ return false; }
		}
