	...
	<!--
		function confirm_delete(id, name, page){	
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				window.location = "<?php echo base_url("/listing/delete_listing/");?>"+"/"+id; 
				return true;
			} 
			else{ return false; }
		}
										...
										<div class="actions">
											<div class="btn-group">
												...
												<ul class="dropdown-menu pull-right">
													<li><a href="<?php echo base_url("listing/new_listing_step_1/"); ?>"><i class="icon-plus"></i> Add New </a></li>
						...
						<div style="padding-bottom:50px">
							<div class="control-group" style="float:left">
								<div class="controls" style="font-weight:bold">									
                                    ...
                                    <input type="hidden" name="s_status" value="<?php echo $post_data["s_status"];?>">
                                    <input type="hidden" name="s_openday" value="<?php echo $post_data["s_openday"];?>">
                                    <input type="hidden" name="openhour_from" value="<?php echo $post_data["openhour_from"];?>">
                                    <input type="hidden" name="openhour_to" value="<?php echo $post_data["openhour_to"];?>">
                                    
                                    <input type="hidden" name="listing_zip" value="<?php echo $post_data["listing_zip"];?>">
                                    <input type="hidden" name="listing_location_1" value="<?php echo $post_data["listing_location_1"];?>">
                                    <input type="hidden" name="listing_location_2" value="<?php echo $post_data["listing_location_2"];?>">
                                    <input type="hidden" name="listing_location_3" value="<?php echo $post_data["listing_location_3"];?>">
                                    
                                    <input type="hidden" name="listing_category_1" value="<?php echo $post_data["listing_category_1"];?>">
                                    <input type="hidden" name="listing_seller" value="<?php echo $post_data["listing_seller"];?>">
