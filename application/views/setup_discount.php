...
<div class="page-container row-fluid">
  ...
  <!-- approval -->
  <?php
			$sidemenu[2] =array("1"=>"active","2"=>array("1"=>"active","2"=>array("1"=>"active")));
      ...
      <div class="row-fluid profile">
        <div class="span12">
            ...
            <div class="span12">
              ...
              <div class="portlet">
                <div class="portlet-title">
                  <div class="caption"><i class="icon-cogs"></i> Manage Discount Codes</div>
                  <div class="actions">
                    <div class="btn-group">
                      <button data-toggle="dropdown" class="btn red dropdown-toggle">Add New <i class="icon-angle-down"></i></button>
                      <ul class="dropdown-menu pull-right">
                        <li><a href="<?php echo base_url('general/new_setup_discount'); ?>"><i class="icon-plus"></i> Add New</a></li>
                        <li><a style="cursor:pointer" onClick="confirm_delete_all('Manage Discount Codes')"><i class="icon-trash"></i> Delete All</a></li>
                        <li><a style="cursor:pointer" onClick="confirm_delete_selected('Manage Discount Codes')"><i class="icon-remove"></i> Delete Selected</a></li>
                        <li><a style="cursor:pointer" onClick="confirm_restore_default('Manage Discount Codes')"><i class="icon-refresh"></i> Restore Default</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
				...
				<?php } ?>
                  <form action="system_setup_discount_update.php" method="post" name="form">
                    ...
                    <table id="sample_1" class="table table-bordered table-advance table-hover">
                      <thead>
                        <tr>
                          ...
                          <th class="span7">Discount Code</th>
                          <th style="text-align:center; width:150px" class="hidden-480">Expire Date</th>
                          <th style="text-align:center; width:150px" class="hidden-480">Percentage</th>
                          <th style="text-align:right" class="span3">Used</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php if(count($discount_list)>0){foreach($discount_list as $k=>$discountObj){ ?>
                        <tr>
                          <td style="padding-top:8px"><div class="checker" id="uniform-undefined"><span>
                              <input type="checkbox" value="yes" class="checkboxes" name="discount_status_delete_1" style="opacity: 0;">
                              </span></div></td>
                          <td style="padding-right:20px"><h5 style="font-weight:700; margin:0"><?php echo $discountObj->discount_code; ?></h5>
                            <div class="btn-group"> <a href="#" data-toggle="dropdown" class="btn mini yellow dropdown-toggle">Edit <i class="icon-angle-down"></i></a>
                              <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url("general/setup_discount_edit/".$discountObj->discount_id);?>"><i class="icon-edit"></i> Edit</a></li>
                                <li><a style="cursor:pointer" onClick="confirm_delete('<?php echo $discountObj->discount_id; ?>','<?php echo $discountObj->discount_code; ?>')"><i class="icon-trash"></i> Delete</a></li>
                              </ul>
                            </div></td>
                          <td style="text-align:center; vertical-align:middle" class="hidden-480"><?php echo $discountObj->discount_expire; ?></td>
                          <td style="text-align:center; vertical-align:middle" class="hidden-480"><?php echo $discountObj->discount_percentage; ?></td>
                          <td style="text-align:right; vertical-align:middle"><?php echo $discountObj->discount_used; ?></td>
                        </tr>
                        <?php }} ?>
                      </tbody>
                    </table>
          ...
          <div style="padding-bottom:50px">
            <div style="float:right;"> <a class="btn mini red" style="cursor:pointer; width:100px; margin-bottom:7px; text-align:left" onClick="confirm_delete_selected('Manage Discount Codes')"><i class="icon-remove"></i> Delete Selected</a> </div>
...
<script type="text/javascript">
		...
		function confirm_delete(id, name){	
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				window.location = "<?php echo base_url()."general/delete_setup_discount/"; ?>" + id; 
				return true;
			} 
			else{ return false; }
		}
