        ...
        <div class="span12">
          <div style="border-color:#004080;" class="portlet box grey">
            <div style="background-color:#004080;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i>Add Radius</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" id="form" action="<?php echo base_url("general/setup_radius_add"); ?>" novalidate="novalidate">
                ...
                <div class="control-group">
                  <label class="control-label">Radius Label (English)<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="radius_name_1">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">Value<span class="required"></span></label>
                  <div class="controls">
                    <input type="text" class="span6 m-wrap" data-required="1" value="" name="radius_value">
                  </div>
                </div>
