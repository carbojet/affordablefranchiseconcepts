        ...
        <div class="span12">
          <div style="border-color:#400000;" class="portlet box grey">
            <div style="background-color:#400000;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit Listing sector</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_sector_listing_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $category_listingObj->category_id; ?>" name="sector_id">
                ...
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                  ...
                  <div class="controls">
                    <h5 style="font-weight:700">Enter sector Name / Title (Required)</h5>
                    <div style="margin-left:0; padding-left:0" class="span6"> You can specify your enter sector Name / Title for each languages. </div>
                  </div>
                </div>
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" class="span8 m-wrap" data-required="1" value="<?php echo $category_listingObj->category_name_1; ?>" name="sector_name_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                ...
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                    <input type="text" style="" class="span8 m-wrap" data-required="1" value="<?php echo $category_listingObj->category_url_1; ?>" name="sector_url_1">
                  </div>
                </div>
                <div class="space20"></div>
                <div style="margin-top:0; margin-bottom:0" class="control-group">
                ...
                <div class="control-group form_field">
                  <label class="control-label">English <span class="required"></span></label>
                  <div class="controls">
                  	<textarea class="span8 m-wrap" row="6" rows="6" name="sector_desc_1"><?php $dest = $category_listingObj->category_desc_1; echo trim($dest); ?></textarea>                    
                  </div>
                </div>
                <div class="space10"></div>
                ...
                <?php
				$url = base_url().'sector_photo/'.$category_listingObj->category_image;
	...
	<!--
		...
		function confirm_delete(id){
			...
			if ( confirm("Do you want to delete this picture / icon?") ){
				...
				window.location = "<?php echo base_url()."general/setup_sector_listing_delete_icon/"; ?>" + id; 				
				...
				init: function () {
					...
					this_form.validate({
						...
						messages: {
														...
														sector_name_1:		{ required: "Please fill this field." },
