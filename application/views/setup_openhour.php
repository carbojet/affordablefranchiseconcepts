...
<div class="page-container row-fluid">
  ...
  <!-- approval -->
  <?php
			$sidemenu[2] =array("1"=>"active","3"=>array("1"=>"active","2"=>array("2"=>"active")));
			$data["sidemenu"] =  $sidemenu; 
			$this->load->view("sidebar",$data);
  ?>
  <!-- BEGIN PAGE -->
  <div class="page-content" data-height="1940" style="">
      ...
      <div class="row-fluid profile">
        <div class="span12">
            ...
            <div class="span12">
              ...
              <div class="portlet">
                <div class="portlet-title">
                  <div class="caption"><i class="icon-cogs"></i> Manage Open Hour Values</div>
                  <div class="actions">
                    <div class="btn-group">
                      <button data-toggle="dropdown" class="btn red dropdown-toggle">Add New <i class="icon-angle-down"></i></button>
                      <ul class="dropdown-menu pull-right">
                        <li><a href="<?php echo base_url("general/setup_openhour_add"); ?>"><i class="icon-plus"></i> Add New</a></li>
                        <li><a style="cursor:pointer" onClick="confirm_delete_all('Manage Open Hour Values')"><i class="icon-trash"></i> Delete All</a></li>
                        <li><a style="cursor:pointer" onClick="confirm_delete_selected('Manage Open Hour Values')"><i class="icon-remove"></i> Delete Selected</a></li>
                        <li><a style="cursor:pointer" onClick="confirm_update_order('Manage Open Hour Values')"><i class="icon-edit"></i> Update Order</a></li>
                        <li><a style="cursor:pointer" onClick="confirm_restore_default('Manage Open Hour Values')"><i class="icon-refresh"></i> Restore Default</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
				...
				if(isset($success_msg))
                  ...
                  <?php } ?>
                  <form action="system_setup_openhour_update.php" method="post" name="form">
                    ...
                    <table id="sample_1" class="table table-bordered table-advance table-hover">
                      ...
                      <tbody>
                      	<?php if(count($openhour_list)>0){ foreach($openhour_list as $k=>$openhourObj){ ?>
                        	<tr>
                          <td style="padding-top:8px"><div class="checker" id="uniform-undefined"><span>
                              <input type="checkbox" value="yes" class="checkboxes" name="openhour_status_delete_1" style="opacity: 0;">
                              </span></div></td>
                          <td style="padding-right:20px"><h5 style="font-weight:700; margin:0"><?php echo $openhourObj->openhour_name_1; ?></h5>
                            <div class="btn-group"> <a href="#" data-toggle="dropdown" class="btn mini yellow dropdown-toggle">Edit <i class="icon-angle-down"></i></a>
                              <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url("general/setup_openhour_edit/".$openhourObj->openhour_id); ?>"><i class="icon-edit"></i> Edit</a></li>
                                <li><a style="cursor:pointer" onClick="confirm_delete('<?php echo $openhourObj->openhour_id; ?>','<?php echo $openhourObj->openhour_name_1; ?>')"><i class="icon-trash"></i> Delete</a></li>
                              </ul>
                            </div></td>
                          <td style="text-align:right"><input type="text" style="" class="span3 m-wrap" data-required="1" value="<?php echo $openhourObj->openhour_order; ?>" name="openhour_status_order_1">
                          </td>
                        </tr>
                        <?php }} ?>
                      </tbody>
          ...
          <div style="padding-bottom:50px">
            <div style="float:right;"> <a class="btn mini yellow" style="cursor:pointer; width:100px; margin-bottom:7px; text-align:left" onClick="confirm_update_order('Manage Open Hour Values')"><i class="icon-edit"></i> Update Order</a><br>
              <a class="btn mini red" style="cursor:pointer; width:100px; margin-bottom:7px; text-align:left" onClick="confirm_delete_selected('Manage Open Hour Values')"><i class="icon-remove"></i> Delete Selected</a> </div>
...
<script type="text/javascript">
		...
		function confirm_delete(id, name){	
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				window.location = "<?php echo base_url()."general/delete_setup_openhour/"; ?>" + id; 
				return true;
			} 
			else{ return false; }
		}
