...
<body class="fixed-top">	
	...
	<div class="page-container row-fluid">		
        ...
        <!-- approval -->
		<?php
			$sidemenu[6] =array("1"=>"active","2"=>array("2"=>"active"));
							...
							<div class="span12">
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption"><i class="icon-money"></i>Pending Payments</div>
						...
						<div style="padding-bottom:50px">
							<div class="control-group" style="float:left">
								<div class="controls" style="font-weight:bold">
									...
									<form name="pagination" action="<?php echo base_url("payment/pending_payments/");?>" method="post">
