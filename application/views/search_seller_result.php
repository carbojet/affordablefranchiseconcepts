                                                    ...
                                                    <td class="span8" style="padding-right:20px; vertical-align:middle">
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">														
                                                                ...
                                                                <li><a onClick="confirm_delete('<?php echo $sellerObj->seller_id; ?>','<?php echo $sellerObj->seller_username;?>','seller')" style="cursor:pointer"><i class="icon-trash"></i> Delete </a></li>
                                                                ...
                                                                <a href="<?php echo base_url("seller/feature/off/".$sellerObj->seller_id); ?>"><i class="icon-star-empty"></i> Un-Feature </a>
                                                                <?php }else{ ?>
                                                                <a href="<?php echo base_url("seller/feature/on/".$sellerObj->seller_id); ?>"><i class="icon-star"></i> Feature </a>
                                                                <?php } ?>
                                                                </li>
                                                                <li>
                                                                <?php if($sellerObj->seller_status_approval=="on"){ ?>
                                                                <a href="<?php echo base_url("seller/auto_approve/off/".$sellerObj->seller_id); ?>"><i class="icon-thumbs-down"></i> Auto Approve Off </a>
                                                                <?php } else { ?>
                                                                <a href="<?php echo base_url("seller/auto_approve/on/".$sellerObj->seller_id); ?>"><i class="icon-thumbs-up"></i> Auto Approve On </a>
                                                                <?php } ?>
                                                                </li>													
                                                            </ul>
                                                        </div>
                        ...
                        <div style="padding-bottom:50px">
                            ...
                            <div style="float:right">
                                <div class="hidden-480" style="float:right">
                                    <div dir="ltr">
                                    <form id="seller_search_pre_page" method="post" action="<?php echo base_url('seller/seller_search_pre_page/'); ?>">
                                    	<input type="hidden" name="seller_type" value="<?php echo $post_data["seller_type"]; ?>" />
                                        <input type="hidden" name="seller_username" value="<?php echo $post_data["seller_username"]; ?>" />
                                        <input type="hidden" name="seller_company" value="<?php echo $post_data["seller_company"]; ?>" />
                                        <input type="hidden" name="seller_firstname" value="<?php echo $post_data["seller_firstname"]; ?>" />
                                        <input type="hidden" name="seller_lastname" value="<?php echo $post_data["seller_lastname"]; ?>" />
                                        <input type="hidden" name="order_by" value="<?php echo $post_data["order_by"]; ?>" />
                                        <input type="hidden" name="startpage" value="<?php echo $pagination["startpage"]; ?>" />
                                    </form>
                                    <form id="seller_search_nxt_page" method="post" action="<?php echo base_url('seller/seller_search_nxt_page/'); ?>">
                                    	<input type="hidden" name="seller_type" value="<?php echo $post_data["seller_type"]; ?>" />
                                        <input type="hidden" name="seller_username" value="<?php echo $post_data["seller_username"]; ?>" />
                                        <input type="hidden" name="seller_company" value="<?php echo $post_data["seller_company"]; ?>" />
                                        <input type="hidden" name="seller_firstname" value="<?php echo $post_data["seller_firstname"]; ?>" />
                                    ...
                                    <a href="#" class="btn black" onClick="document.getElementById('seller_search_pre_page').submit();"><i class="m-icon-swapleft m-icon-white"></i> Prev</a>
                                    
                                    <a href="#" class="btn black" onClick="document.getElementById('seller_search_nxt_page').submit();">Next <i class="m-icon-swapright m-icon-white"></i></a>
                                    </div>
                                </div>
                            </div>
