...
//		}		
		function confirm_delete(id, name){	
			if ( confirm("Do you want to delete this data?\n( Current Data : " + name + " )") ){
				window.location = "<?php echo base_url('seller/listing_package_delete/') ?>/" + id; 
				return true;
			} 
			else{ return false; }
		}		
							...
							<div class="span12">
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption"><i class="icon-cogs"></i> Manage Listing Packages</div>
										<div class="actions">
											<div class="btn-group">
												<button class="btn red dropdown-toggle" data-toggle="dropdown">Add New <i class="icon-angle-down"></i></button>
												<ul class="dropdown-menu pull-right">
													<li><a href="<?php echo base_url("seller/add_listing_package"); ?>"><i class="icon-plus"></i> Add New</a></li>
                                    ...
                                    <?php
									  ...
									  <?php } ?>
										...
										<thead>
										<tr>
											<th class="span9">Package</th>
											<th class="span3"></th>
										</tr>
										</thead>
										<tbody>
                                        <?php foreach($listing_package_result as $k=>$listingObj){?>
											<tr>
											<td style="padding-right:20px; vertical-align:middle">												
												
												<h5 style="font-weight:700; margin:0"><?php echo $listingObj->package_listing_name_1; ?></h5>
												
												<div class="hidden-480" style="margin-left:70px; margin-top:20px">
													<div class="span4">
														
														<div class="td_label"># Categories</div>
														<div class="td_value"><?php echo $listingObj->package_listing_category; ?></div>
														<div class="td_clear"></div>
														
														<div class="td_label"># Pictures</div>
														<div class="td_value"><?php echo $listingObj->package_listing_pics; ?></div>
														<div class="td_clear"></div>
														
														<div class="td_label"># Videos</div>
														<div class="td_value"><?php echo $listingObj->package_listing_video; ?></div>
														<div class="td_clear"></div>
														
														<div class="td_label"># Documents</div>
														<div class="td_value"><?php echo $listingObj->package_listing_doc; ?></div>
														<div class="td_clear"></div>
														
														<div class="td_label"># Events</div>
														<div class="td_value"><?php echo $listingObj->package_listing_event; ?></div>
														<div class="td_clear"></div>
														
														<div class="td_label"># Coupons</div>
														<div class="td_value"><?php echo $listingObj->package_listing_coupon; ?></div>
														<div class="td_clear"></div>

														<div class="td_label"># Products</div>
														<div class="td_value"><?php echo $listingObj->package_listing_product; ?></div>
														<div class="td_clear"></div>
														
														<div class="td_label"># News</div>
														<div class="td_value"><?php echo $listingObj->package_listing_news; ?></div>
														<div class="td_clear"></div>
														
													</div>
													<div class="span4">
														
														<div class="td_label">Price</div>
														<div class="td_value">$ <?php echo $listingObj->package_listing_price; ?></div>
														<div class="td_clear"></div>
														
														<div class="td_label">Days / Period</div>
														<div class="td_value"><?php echo $listingObj->package_listing_days; ?></div>
														<div class="td_clear"></div>
														
																												
														<div class="td_label">Renewable?</div>
														<div class="td_value"><?php echo $listingObj->package_listing_renew; ?></div>
														<div class="td_clear"></div>
														
														<div class="td_label">Featured</div>
														<div class="td_value"><?php echo $listingObj->package_listing_featured; ?></div>
														<div class="td_clear"></div>
											...
											<td style="text-align:right; vertical-align:middle">
												...
												<div class="btn-group" style="text-align:left">
													...
													<ul class="dropdown-menu pull-right">
														<li><a href="<?php echo base_url('seller/listing_package_edit/'.$listingObj->package_listing_id); ?>"><i class="icon-edit"></i> Edit</a></li>
														<li><a onClick="confirm_delete('<?php echo $listingObj->package_listing_id; ?>','<?php echo $listingObj->package_listing_name_1; ?>')" style="cursor:pointer"><i class="icon-trash"></i> Delete</a></li>
													</ul>
												</div>
											</td>
										</tr>
