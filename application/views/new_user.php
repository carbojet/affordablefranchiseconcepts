					...
					<div class="span12">						
						<div class="portlet box grey" style="border-color:#7D1B7E;">
							...
							<div class="portlet-title" style="background-color:#7D1B7E;">
								<div class="caption"><i class="icon-edit"></i>Add New User</div>
							</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form action="<?php echo base_url("/user/new_user/"); ?>" id="form" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                    <!--alert box -->
									<?php
                                  ...
                                  <?php } ?>
									...
									<div class="control-group form_field">
										...
										<div class="controls">
											<input type="text" name="user_username" value="<?php echo $userObj->user_username; ?>" data-required="1" class="span3 m-wrap" >
										</div>
									</div>
									<div class="control-group form_field">
