        ...
        <div class="span12">
          <div class="portlet box grey" style="border-color:#800000;">
            <div class="portlet-title" style="background-color:#800000;">
              <div class="caption"> <i class="icon-edit"></i> Edit Page </div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form name="form" id="form" action="<?php echo base_url('pages/update/');?>" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
              	<input type="hidden" name="post_id" value="<?php echo $pageObj->ID?>"/>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="post_title" value="<?php echo $pageObj->post_title; ?>" class="span12 m-wrap" />
                  </div>
                </div>
				<div class="control-group">
				  ...
				  <?php //var_dump($pageObj); ?>
                    <input type="text" name="post_name" value="<?php echo $pageObj->post_name; ?>" class="span12 m-wrap" />
                  </div>
                </div>
				<div class="control-group">
                  <label class="control-label"> Keywords </label>
                  <div class="controls">
                    <input type="text" name="page_keywords" value="<?php if(isset($pageObj->page_keywords)){ echo $pageObj->page_keywords;}?>" class="span12 m-wrap" />
                  </div>
                </div>
				<div class="control-group">
                  <label class="control-label"> Meta Description </label>
                  <div class="controls">
                    <input type="text" name="page_meta_description" value="<?php if(isset($pageObj->page_meta_description)){ echo $pageObj->page_meta_description;}?>" class="span12 m-wrap" />
                  </div>
                </div>
                <div class="space20"></div>
                <div class="space20"></div>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <textarea name="post_content" class="span8 ckeditor m-wrap" rows="6" style="visibility: hidden; display: none;"><?php echo $pageObj->post_content;?></textarea>
