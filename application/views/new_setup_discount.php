  ...
  <div class="page-content">
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid inbox">
        <div class="span12">
          <div style="border-color:#7D1B7E;" class="portlet box grey">
            <div style="background-color:#7D1B7E;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Add Discount Code</div>
            </div>
            <div class="portlet-body form">
              <?php 

								 if(isset($validation_errors)){ ?>
              <div style="margin:10px 0 10px 0" class="alert alert-error ">
                ...
                <div style="min-height:31px; vertical-align:middle;"> <?php echo $validation_errors; ?> </div>
                </font> </div>
              <?php } ?>
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url('general/new_setup_discount'); ?>" id="form" name="form" novalidate="novalidate">
                ...
                <div class="control-group form_field">
                  <label class="control-label">Discount Code <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="" name="discount_code">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">Percentage (%)<span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="" name="discount_percentage">
                  </div>
                </div>
                <div class="control-group form_field">
                  <label class="control-label">Expire Date <span class="required">*</span></label>
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="" name="discount_expire">
                    <br>
                    <br>
                    Please enter a valid date using YYYY-MM-DD format for Expire Date. </div>
                </div>
                <div class="form-actions">
                  <button style="background-color:#7D1B7E;" class="btn black" type="submit"><i class="icon-ok"></i> Save</button>
                </div>
              </form>
              <!-- END FORM-->
            </div>
