        ...
        <div class="span12">
          <div style="border-color:#400000;" class="portlet box grey">
            <div style="background-color:#400000;" class="portlet-title">
              <div class="caption"><i class="icon-edit"></i> Edit  Currency Code</div>
            </div>
            <div class="portlet-body form">
              <!-- BEGIN FORM-->
              <form enctype="multipart/form-data" method="post" class="form-horizontal" action="<?php echo base_url("general/setup_currency_update"); ?>" id="form" name="form" novalidate="novalidate">
                <input type="hidden" value="<?php echo $currencyObj->currency_id; ?>" name="currency_id">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="<?php echo $currencyObj->currency_name; ?>" name="currency_name">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="<?php echo htmlentities($currencyObj->currency_symbol); ?>" name="currency_symbol">
                ...
                <div class="control-group form_field">
                  ...
                  <div class="controls">
                    <input type="text" style="" class="span4 m-wrap" data-required="1" value="<?php echo $currencyObj->currency_code; ?>" name="currency_code">
