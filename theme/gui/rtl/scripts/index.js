    ...
    return {
        ...
        initDashboardDaterange: function () {
            ...
            function (start, end) {
                ...
                setTimeout(function () {
                    App.unblockUI(jQuery("#dashboard"), false);
                    $.gritter.add({
                        title: 'Dashboard',
                ...
                $('#dashboard-report-range span').html(end.toString('MMMM d, yyyy') + ' - ' + start.toString('MMMM d, yyyy'));

            });

            $('#dashboard-report-range').show();

            $('#dashboard-report-range span').html(Date.today().toString('MMMM d, yyyy') + ' - ' + Date.today().add({
                days: -29
        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Meet EasyRealEstateScript!',
                    // (string | mandatory) the text inside the notification
                    text: 'EasyRealEstateScript is a brand new Responsive Admin Dashboard Template you have always been looking for!',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    // (string | mandatory) the heading of the notification
                    title: 'Buy EasyRealEstateScript!',
                    // (string | mandatory) the text inside the notification
                    text: 'EasyRealEstateScript comes with a huge collection of reusable and easy customizable UI components and plugins. Buy EasyRealEstateScript today!',
                    // (string | optional) the image to display on the left
                    image: './assets/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'Customize EasyRealEstateScript!',
                    // (string | mandatory) the text inside the notification
                    text: 'EasyRealEstateScript allows you to easily customize the theme colors and layout settings.',
                    // (string | optional) the image to display on the left
