...
function find_child_location(new_value, max_level, url_count, url_list, level_current, box_id, box_notification) {		
	...
	var temp_box	= '';
        ...
        //custom script addon for easy directory manager wp-plugins

        url_count='http://www.trustedhomecontractors.com/directory/'+url_count;
        url_list='http://www.trustedhomecontractors.com/directory/'+url_list;
